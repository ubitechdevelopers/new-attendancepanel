...
class Clientsettings extends CI_Controller {
	...
	public function viewclientlocation() {
		
		 $data['latitin']=$this->Clientmodel->getlattitude();
		 //var_dump($data['latitin']);
		 //die;
		 
			
        $this->load->view('home/clientmap',$data);
    }
	
	
	public function viewclientlocationout() {
		
		 $data['latitin']=$this->Clientmodel->getlattitude();
		 //var_dump($data['latit_out']);
		 //die;
		
        $this->load->view('home/clientmapout',$data);
    }
...
$postdata=$this->input->post();
  ...
  public function getClientlist(){
   // $postData= $this->input->post();
    $this->load->model('Clientmodel');
    $data=$this->Clientmodel->getClientlist();
   // echo json_encode($data);
}
