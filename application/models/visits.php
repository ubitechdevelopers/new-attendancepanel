                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                       <!--  <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Checkbox</label><br> -->
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk1" disabled>&nbsp; Date</label><br>
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk2" disabled >&nbsp; Visited Client</label><br>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled>&nbsp; Visit In</label><br>
                                         ...
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" disabled>&nbsp; Visit Out</label><br>
                                      
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk5" disabled>&nbsp;  Visit Hours</label><br>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6" >&nbsp;Remarks </label><br>
...
<div class="modal fade" id="locationmodal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <form>
                ...
                <input type="text" id="latitid">
                <input type="text" id="latitinid">
                <input type="text" id="longiid">
                <input type="text" id="checkinloc">
    <div class="row">
                <div class="col-md-12">
   ...
   },
   {
        ...
        "serverMethod":"post",    
         ...
         "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Clientsettings/punchedLocations?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
                 "columns": [
