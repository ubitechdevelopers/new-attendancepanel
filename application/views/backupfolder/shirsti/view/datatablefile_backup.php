...
<div class="row " id="addhead">
  <div class="col-6 col-sm-6 col-md-9 col-lg-10" id="addemp"><a href="<?php echo URL; ?>Userprofiles/employeelist" style="color: #000"><i class="fa fa-chevron-left" id="arrow">&nbsp;<b>Employee List</b></i></a></div>
        
            <div class="col-6 col-sm-6 col-md-3 col-lg-2" id="self"><i class="fa fa-user-circle-o"></i>&nbsp;Self Registration</i></div>
        </div><hr>
            <div class="container">
                    ...
                    <fieldset>
                        <div class="row">
                            ...
                            <div class="col-10 col-sm-4 col-md-4 col-lg-4">
                                ...
                                <img src="http://ubiattendance.zentylpro.com/ubiattnew2/index.php/../assets/img/profile.png" class="rounded-circle circle mr-5" alt="Cinque Terre"><br>
                        ...
                        <div class="form-group">
                            ...
                            <option value="0">-Select-</option>
                                        ...
                                        ?>
                            </select><i class="fa fa-angle-down" id="angle"></i>
                        </div><br>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    <label for="password" class="form-label required">Password</label>
                                    <input type="password" name="password" id="password" ><i class="fa fa-lock" id="pswrd"></i>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    <label for="password" class="form-label required">Confirm Password</label>
                                    <input type="password" name="cpassword" id="cpassword"><i class="fa fa-lock" id="cpswrd"></i>
                                </div>
                            </div>
                        </div>
                    </fieldset>
