	   ...
	   <?php 
			   ...
			   
			   {
				  echo " <div style='font-size: 1.5625rem; font-weight:700;margin-left: 233px;line-height: 30px; color: #000000;'>Manage</div>";
				   ...
				   echo " <div style='font-size: 1.5625rem; font-weight:700;margin-left: 233px;line-height: 30px; color: #000000;'>Import Department Record</div>";
         ...
         {
          echo " <div style='font-size: 1.5625rem; font-weight:700; margin-left: 233px;line-height: 30px; color: #000000;'>Addons
          </div>";
         }
         ...
         <div class="navbar-collapse dual-nav order-1">
            ...
            <ul class="nav navbar-nav" style="position:absolute;right:0;padding-right:4%; top:7px;">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style=" min-width: 0rem;font-size: 0.9rem;margin-left: -1.4rem; ">
		<!-- <a class="dropdown-item drop" href="<?php echo URL ; ?>/Upgrade">My Plan</a> -->
          ...
          <a class="dropdown-item drop" href="<?=URL;?>logout">Logout</a>
