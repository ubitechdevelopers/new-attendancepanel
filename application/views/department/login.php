...
<div class="container-fluid">
  ...
  <h3 style="font-weight: 700;line-height: 1.2;">Supervisor Login</h3>
  ...
  <?php if($d == NULL) {?>
   ...
   <!--  <div class="form-group">
    ...
    <div id="remember-me" class="form-check ">
                  ...
                  <a class="forget-password" style="float: right;font-weight: 600;color: #3FAE3E;" href="#">Forget Password</a>
                </div><br><br>
					...
					success: function (data) {
						...
						else
						{
							console.log(JSON.stringify(data));
								...
								location.replace("<?=URL?>departmenthead/allattendance");
								}
