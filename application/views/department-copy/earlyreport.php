										...
										<!--<h3 class="text-center">   Employee Late Report</h3>-->
											...
											<thead>
												...
												<tr style="background-color:#008067;color:#ffffff;">
													...
													<th width="10%"  class="text-left">Time Out </th>
													<!--<th>Time Out</th>
													<th width="10%"  class="text-left">count</th>
													<!--<th>Total Time</th>-->
													<th  width="15%"  class="text-left">Early By </th>
													<th>Device</th>
												</tr>
											</thead>
										</table>
...
<!-----delete employee close--->
  ...
  <script>
            function openNav() 
            {
              ...
              $('#sidenavData').load('<?=URL?>help/helpNav',{'pageid' :'earlyreport'});  
            }
            function closeNav() {
    	...
    	$(document).ready(function() {
            ...
            repeatingHead:{
               ...
               logoPosition: 'center',
                ...
                title: 'Early Leavers report of '+org+' Dated '+isoDateString+'',
            ...
            customize: function (win) {
				...
				"ajax": "<?php echo URL;?>departmenthead/getearlyleave__new?datestatus="+1,
				"columnDefs": 
				[
...
////---------/date picker
		...
		$('#getAtt').click(function(){
            ...
            customize: function (win) {
                ...
                $(win.document.body).find('table')
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>departmenthead/getearlyleave__new?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": [
					{ "visible": false, "targets": [0,2,8] }
				],
					"columns": [
  ...
  <script>
    ...
    $("#sidebar").load('<?=URL?>admin/helpNav',{'pageid': 'earlyreport'}); 
    });
