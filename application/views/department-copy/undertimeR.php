              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <!--  <h4 class="title">Attendance</h4> -->
                   <p class="category" style="color:#ffffff;font-size:17px;" >List of Undertime</p>
    	...
    	$(document).ready(function() {
            ...
            repeatingHead:{
               ...
               logoPosition: 'center',
                ...
                title: 'Undertime report of '+org+' Dated '+isoDateString+'',
            ...
            customize: function (win) {
				...
				"ajax": "<?php echo URL;?>departmenthead/underTimeR",
				"columnDefs": [
		...
		$('#getAtt').click(function(){
            ...
            customize: function (win) {
                ...
                $(win.document.body).find('table')
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>departmenthead/underTimeR?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": 
					[
					{"visible": false, "targets": [0,2] }
					],
