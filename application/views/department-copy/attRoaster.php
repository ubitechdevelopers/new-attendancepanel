	    ...
	    <div class="main-panel">
			...
			<div class="content" id="content">
	            <div class="container-fluid">
	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                           <div class="card-header" data-background-color="green">
	                              <p class="category" style="color:#ffffff;font-size:17px;" >Monthly Register</p>
					...
					<div style="width:232px;height:35px;border :1px solid #acadaf; position:relative; margin-left:-10px;margin-top:0px;" >
				...
				<select id="area" style="width:158px;height:35px;position:relative;right:10px;" class="">
				 ...
				 <button id="export" data-export="export" class="dt-button buttons-excel buttons-html5" style="margin-bottom:5px; margin-left: 5px;"  >Excel</button>
  ...
  <script>
	...
	<script>
	   ...
	   function openNav() 
	   {
		...
		$('#sidenavData').load('<?=URL?>help/helpNav/7',{'pageid' :'monthlyregister'});	
	   }
		function closeNav() 
		{
	...
	$("#sidebar").load("<?=URL?>admin/helpnav",{'pageid':'monthlyregister'});
	});
	});
	</script>
