                        ...
                        <div class="card">
                           ...
                           <div class="card-content">
                              <div id="typography">
								 ...
								 <hr/>
								 <table id="example" class="display table"  width="100%"  height="50%" >
                                          <thead>
                                             <tr>
                                          ...
                                          <tbody>
                                             <?php
                                                ...
                                                // <td><a href="http://maps.google.com/?q='.$row->latit.','.$row->longi.'" target="_blank" title="Click here to view the location on map" >'.$row->location.'</a></td>
                                               
                                                // <td>'.substr($row->time_out,0,5).'</td>
                                               
                                                // <td><a href="http://maps.google.com/?q='.$row->latit_out.','.$row->longi_out.'" target="_blank" title="Click here to view the location on map" >'.$row->location_out.'</a></td>
                                               
                                                // <td>
                                               
                                                // '.substr($row->workhour,0,5).'
                                             ...
                                             <?php
                                               ...
                                               /*  if($detail[$i]['exitimage']=='-'){
                                                ...
                                                $imgout='<i class="pop" data-toggle="modal" data-target="#imagemodal"><img src="'.$detail[$i]['exitimage'].'"  style="width:60px!important; "/>';
                                          ...
                                          <!--<tfoot style="display:none">
                                             <tr style="background-color:#ddd;">
                                              ...
                                              <td  style="font-weight:bold;">Time In:  <?php echo $timein; ?></td>
                                             
                                             
                                             
                                              <td   style="font-weight:bold;padding:35px;">Time Out:    <?php echo $timeout; ?> </td>
                                             
                                             
                                             
                                              <td  style="font-weight:bold;padding:2px;">worked Hours: <?php echo $workhours; ?> </td>
                                             
                                             
                                             
                                             
                                             
                                              <td   style="font-weight:bold;padding: 0px;">ODO Start:
                                             
                                              <?php echo $odostart; ?></td>
                                             
                                             
                                             
                                              <td   style="font-weight:bold;padding: 0px;">ODO End:  <?php echo $odoend; ?>  </td>
                                             
                                             
                                             
                                              <td  style="font-weight:bold;">Tractor No: <?php echo $tracno; ?></td>
                                             ...
                                             <tr style="background-color:#ddd;">
                                              ...
                                              <td colspan="2" style="font-weight:bold;">Time In:  <?php echo $timein; ?></td>
                                             
                                             
                                             
                                              <td colspan="2"  style="font-weight:bold;padding:35px;">Time Out:    <?php echo $timeout; ?> </td>
                                             
                                             
                                             
                                              <td colspan="2"  style="font-weight:bold;padding:2px;">worked Hours: <?php echo $workhours; ?> </td>
                                             
                                             
                                             
                                             
                                             
                                              <td colspan="2"  style="font-weight:bold;padding: 0px;">ODO Start:
                                             
                                              <?php echo $odostart; ?></td>
                                             
                                             
                                             
                                              <td colspan="2"  style="font-weight:bold;padding: 0px;">ODO End:  <?php echo $odoend; ?>  </td>
                                             
                                             
                                             
                                              <td colspan="2"  style="font-weight:bold;">Tractor No: <?php echo $tracno; ?></td>
