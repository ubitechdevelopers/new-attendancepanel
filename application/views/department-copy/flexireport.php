              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <!--  <h4 class="title">Attendance</h4> -->
                   <p class="category" style="color:#ffffff;font-size:17px;" >List of Flexi Attendance</p>
											...
											<thead>
												<tr style="background-color:#008067;color:#ffffff;">
													...
													<!--<th>Visited Client</th>-->
													 ...
													 <th>Time In Date</th>
													<th >Time In</th>
													<th width="15%">Visit In</th>
													<th>Visit Out Image</th>
													<th>Time Out Date</th>
													<th >Time Out</th>
												<!--	<th >Total Time</th> -->
													<th width="15%">Visit Out</th>
													<th>Logged Hours</th>
													<th >Action</th>
												</tr>
											</thead>
...
<!-----delete employee close--->
  ...
  <script>
            function openNav() 
            {
              ...
              $('#sidenavData').load('<?=URL?>help/helpNav',{'pageid' :'flexireport'});  
            }
            function closeNav() {
    	...
    	$(document).ready(function(){
            ...
            repeatingHead:{
               ...
               logoPosition: 'center',
                ...
                title: 'Flexi report of '+org+' Dated '+isoDateString+'',
            ...
            customize: function (win) {
				...
				"ajax": "<?php echo URL;?>departmenthead/punchedFlexi",
				"columnDefs": [
...
////---------/date picker
		...
		$('#getAtt').click(function(){
            ...
            customize: function (win) {
                ...
                $(win.document.body).find('table')
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>departmenthead/punchedFlexi?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": 	[
					                   { "visible": false, "targets": [1,3,7]},
									],
  ...
  <script>
    ...
    $("#sidebar").load('<?=URL?>admin/helpNav',{'pageid': 'flexireport'}); 
    });
