    	...
    	$(document).ready(function() {
			...
			'pageLength','csv','excel','copy',
		  {
            ...
            customize: function (win) {
				...
				"ajax": "<?php echo URL;?>departmenthead/getLate__new?datestatus="+1,
				"columnDefs": 
				[
			 ...
			 'pageLength','csv','excel','copy',
		   {
            ...
            customize: function (win) {
                ...
                $(win.document.body).find('table')
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>departmenthead/getLate__new?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": [
					{ "visible": false, "targets": [0,2,8] }
				],
					"columns": [
