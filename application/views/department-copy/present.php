...
<!-- 					<div style="position: absolute;margin-top: 105px;left: 75%;z-index: 999;">
                    <label for="search">Search: </label>
                    <input type="text"  class="search innershadow" placeholder="" style="box-shadow: inset 0 0 0px 0px #888; height: 24px" ></input>
                    </div>	 -->		
...
<script type="text/javascript">
   // $(document).ready(function() {
    ...
    'pageLength',
	  ...
	  //window.location.href = 'http://ubiattendance.zentylpro.com/index.php/admin/getexcel?date='+range;
	  
	  window.location.href = '<?php '.URL.'?>getexceldata?date='+range;
                }
            }, */
	
        {
          extend: 'csv',
          exportOptions: {
          columns: [0,1,3,4,5,6,8,9,10,12,13,14,15]}
      },
      {
          extend: 'excel',
          exportOptions: {
	...
	//"lengthMenu": [[2,100],[2,100]],
  //columnDefs: [ { orderable: false, targets: [15,16]}],
  
    "contentType": "application/json",
    "ajax": "<?=URL?>departmenthead/getAttendancesPresent?datestatus="+1+datestring,
    "columnDefs": 
  [
    { "visible": false, "targets": [0,2,4,5,9,14] }
    ],
   ...
   "drawCallback": function ( settings ) {
		...
		alert(currentPage);  */ //  $('input.timepicker').timepicker();
    ...
    $('#getAtt').click(function(){ 
	  ...
	  //window.location.href = 'http://ubiattendance.zentylpro.com/index.php/admin/getexceldata?date='+range;
	  window.location.href = '<?php '.URL.'?>getexceldata?date='+range;
  ...
  //columnDefs: [ { orderable: false, targets: [14,15]}],
    ...
    "contentType": "application/json",
    "ajax": "<?=URL?>departmenthead/getAttendancesPresent?date="+range+"&shift="+shift+"&dept="+dept+"&empl="+empl+"&desg="+desg+"&county="+county,
    "columnDefs": [
          { "visible": false, "targets": [0,2,4,5,9,14] }
          ],
    "columns": [
...
// alert(time1);
      ...
      success: function(result){
        ...
        if(result==1)
        {
		  ...
		  //Table.ajax.reload();  
		  //$('#example').ajax.reload(null, false)
          $('#example').DataTable().ajax.reload(null, false); // null or false keep on page in pagination
        }
