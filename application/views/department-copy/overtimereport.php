              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <!--  <h4 class="title">Attendance</h4> -->
                   <p class="category" style="color:#ffffff;font-size:17px;" >List of Overtime</p>
...
<!-----delete employee close--->
  ...
  <script>
            function openNav() 
            {
              ...
              $('#sidenavData').load('<?=URL?>help/helpNav',{'pageid' :'overtimereport'});  
            }
            function closeNav() {
    	...
    	$(document).ready(function() {
            ...
            repeatingHead:{
               ...
               logoPosition: 'center',
                ...
                title: 'Overtime report of '+org+' Dated '+isoDateString+'',
            ...
            customize: function (win) {
				...
				"ajax": "<?php echo URL;?>departmenthead/overTimeR",
				"columnDefs": [
...
////---------/date picker
            ...
            customize: function (win) {
                ...
                $(win.document.body).find('table')
				 ...
				 //'colvis'   "+range+"&shift="+shift+"&deprt="+deprt,
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>departmenthead/overTimeR?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": [
					{ "visible": false, "targets": [0,2] }
				],
					...
					api.column(2, {page:'current'} ).data().each( function ( group, i ) {
						if ( last !== group ) {
							$(rows).eq( i ).before(
								'<tr class="group"><td bgcolor="#d59ff2" colspan=8><b>'+group+'</b></td> <b> &nbsp; &nbsp; </b></tr>'
							);
							last = group;
						}
					} );
  ...
  <script>
    ...
    $("#sidebar").load('<?=URL?>admin/helpNav',{'pageid': 'overtimereport'}); 
    });
