              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <!--  <h4 class="title">Attendance</h4> -->
                   <p class="category" style="color:#ffffff;font-size:17px;" >Date Wise</p>
...
<!-----delete employee close--->
  ...
  <script>
            function openNav() 
            {
              ...
              $('#sidenavData').load('<?=URL?>help/helpNav',{'pageid' :'Punchvisitdate'});  
            }
            function closeNav() {
...
var isoDateString = date.toISOString().substring(0,10);
        ...
        'colvis',
				...
				"columnDefs": [
					{ "className":'dt-center', "visible": false, "targets":[ 0, 2 ]}
					,
...
////---------/date picker
  ...
  <script>
    ...
    $("#sidebar").load('<?=URL?>admin/helpNav',{'pageid': 'Punchvisitdate'}); 
    });
