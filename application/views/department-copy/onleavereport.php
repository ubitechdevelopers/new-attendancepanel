              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <!--  <h4 class="title">Attendance</h4> -->
                   <p class="category" style="color:#ffffff;font-size:17px;" >List of On leave</p>
...
<!--delete employee close-->
  ...
  <script type="text/javascript">
	...
	var isoDateString = date.toISOString().substring(0,4);
			...
			'pageLength','csv','excel','copy',
		  {
            ...
            repeatingHead:{
               ...
               logoPosition: 'center',
                ...
                title: 'Late Comers report of '+org+' Dated '+isoDateString+'',
            ...
            customize: function (win) {
				...
				"ajax": "<?php echo URL;?>departmenthead/Onleavereport?datestatus="+1,
				 "columnDefs": 
				[
			 ...
			 'pageLength','csv','excel','copy',
		   {
            ...
            customize: function (win) {
                ...
                $(win.document.body).find('table')
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>departmenthead/Onleavereport?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					 "columnDefs": [
					{ "visible": false, "targets": [4] }
				],
					"columns": [
