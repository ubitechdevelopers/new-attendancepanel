              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <!--  <h4 class="title">Attendance</h4> -->
                   <p class="category" style="color:#ffffff;font-size:17px;" >List Of Leave Applications</p>
                  ...
                  <div class="card-content">
					...
					<div class="col-sm-2">
						<select id="status" style=" width:158px;height:35px;position:relative; right:10px;" class="">
										...
										<!--<h3 class="text-center">   Employee Late Report</h3>-->
											...
											<thead>
												...
												<tr style="background-color:#008067;color:#ffffff;">
													...
													<th  width="10%"class="text-left">Applied on</th>
													<th  width="10%"class="text-left">Leave From </th>
													<th  width="10%"class="text-left">Leave To </th>
													<th  width="10%"class="text-left">Leave Days</th>
													<th  width="10%"class="text-left">Reason</th>
													<th  width="10%"class="text-left">Status</th>
													<th  width="10%"class="text-left">Remarks</th>
...
<div id="ApproveLeave" class="modal fade" role="dialog">
      <div class="modal-dialog"> 
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="title">Leave Status</h4>
          </div>
          <div class="modal-body">
            <form id=remref>
...
<!--        <input type="radio" id="timeout" name="deleteout" value="out">
        <label for="timeout" style='color:black'>Delete "Time Out"</label><br> -->
				...
				<textarea  placeholder="Remarks" id="remark"  style="border-radius: 5px; width: 55.5rem; height: 7rem;"></textarea>

<!--         <textarea placeholder="Remarks" style="width: 55rem;height: 7rem;"></textarea>
 -->       <!--  <input type="textarea" name="" class="form-control" placeholder="Remarks"> -->
        </div>
          ...
          <div class="modal-footer">
            ...
            <button type="button" id="approveL"  class="btn" style="margin-top: -10px; background-color: green;">Approve</button>
            
             <button type="button" id="rejectL"  class="btn btn-warning" style="margin-top: 0px;background-color: #ff9525;">Reject</button>
  ...
  var isoDateString = date.toISOString().substring(0,10);
    	...
    	$(document).ready(function() {
            ...
            customize: function (win) {
				...
				"ajax": "<?php echo URL;?>departmenthead/leavereport",
				"columnDefs": [
					{ "visible": false, "targets": [1] },
					 // {"text-left sorting": "dt-center", "targets": "_all"}
				],
				 "columns": [
				    // { "data": "code" },
					{ "data": "Name" },
...
////---------/date picker
		...
		$('#getAtt').click(function(){
            ...
            customize: function (win) {
                ...
                $(win.document.body).find('table')
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>departmenthead/leavereport?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&status="+status,
					"columnDefs": [
					{ "visible": false, "targets": [1] }
				],
					"columns": [
    ...
    processData: false,
    contentType: false,
    url: "<?php echo URL;?>departmenthead/approveleave",
    data: formdata,
    datatype:"json",
    type:"post",
    success: function(result){
    ...
    processData: false,
    contentType: false,
    url: "<?php echo URL;?>departmenthead/rejectleave",
    data: formdata,
    datatype:"json",
    type:"post",
    success: function(result){
