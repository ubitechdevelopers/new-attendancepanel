  ...
  .flex-wrap {
   ...
   <body>
      ...
      <main class="main" style="width: 83.7%;">
                        ...
                        <div class="col-lg-11">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/notreport"  class="subhead" style="margin-left:70px;">NotReported</a></span></div>
                                    ...
                                    <div class="swiper-slide"> <span><a href="<?= URL; ?>Attendance/ontimeoff" class="subhead" style="margin-left:70px;">On Time off</a></span></div>
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/onleave" class="subhead" style="margin-left:70px;">On Leave</a></span></div>
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/disapproved" class="subhead" style="margin-left:70px;">Disapproved & Approved</a></span></div>
                                    ...
                                    <div class="swiper-slide"><span  class="active5"><a href="<?= URL; ?>Attendance/customizedrept" class="subhead" style="margin-left:70px;">Customized Report</a></span></div>
          ...
          <thead>
                              <tr>
                                ...
                                <th width='80%'>Project Id Time In(Time In Location)</th>
                                <th>Time Out</th>
                                <th width='1%' >Time Out Image</th>
                                <th width='80%'>Project Id Time Out(Time Out Location)</th>
                                <th>Hours</th>
                                <th>Device</th>
                                <th>HourType</th> 
                                <th>Overtime</th> 
                                <th width='10%'>Working Day Type</th> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                      <!--  <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Checkbox</label><br>-->
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Attendence Type </label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk1" disabled>&nbsp;Name</label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk2" disabled>&nbsp;Code</label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled>&nbsp;Shift </label><br>
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" disabled >&nbsp;Location</label>
                                        <br>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk5" disabled>&nbsp;  Date</label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6" disabled>&nbsp;Time In </label><br> 
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk7" disabled>&nbsp;Time in Image</label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk8" disabled>&nbsp;Time In location</label><br>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk9" disabled>&nbsp;Time out </label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk10" disabled>&nbsp;Time Out Image</label><br>
                                       
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk11" disabled>&nbsp;Time out location</label><br>
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk12" disabled>&nbsp;Hours  </label><br>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                          ...
                                          <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk13" disabled>&nbsp;Device</label>

                                          <br>
                                          <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk14" disabled>&nbsp;  Hours Type</label>
                                        <br>
                                           <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk15" disabled>&nbsp;Overtime</label><br>
                                           <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk16" disabled>&nbsp;Working day Type</label>
                                        <br>
                                    </div>
    ...
    <?php 
							  ...
							  exportOptions:
							  
								{
								 /*  modifier: 
								  ...
								  columns: [0,1,2, 3, 4, 5,6,8,9,11,12,13,14,15,16] 
								},
      ...
      title: 'Customized Report of '+org+' Dated '+isoDateString+'',
      ...
      "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getCustomizedReport?datestatus="+7,
                 "columns": [
                  { "data": "atttype" },
                  { "data": "name" }, 
                  { "data": "code" },
 ...
 $('#getAtt').click(function(){
      ...
      "scrollX": true,                  
       "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getCustomizedReport?date="+range+"&shift="+shift+"&dept="+dept+"&empl="+empl+"&desg="+desg+"&area="+area,
                 "columns": [
                { "data": "atttype" },
                { "data": "name" }, 
                { "data": "code" },
