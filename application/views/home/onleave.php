...
<div id="heading2" class="sticky" style="z-index: 500; padding-bottom: 30px;">
                        ...
                        <div class="col-lg-11">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"><span class="active5"><a href="<?= URL; ?>Attendance/onleave" class="subhead" style="margin-left:70px;">On Leave</a></span></div>
           ...
           <thead>
                        ...
                        <tr>
                          ...
                          <th  width=""  class="text-left">Reason</th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                      <!--  <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Checkbox</label><br>-->
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Name </label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk1" disabled>&nbsp;shift</label><br>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                      <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk2" disabled >&nbsp;Date</label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled>&nbsp;Reason</label><br>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" >&nbsp; Department</label><br>
   ...
   <?php 
     ...
     buttons:[{ 
      ...
      title: 'OnLeave of '+org+' Dated '+isoDateString+'',
      ...
      "scrollX": true,                  
       "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/Onleavereport?datestatus="+1,
                 "columns": [
          { "data": "Name" },
          { "data": "shift" },
          { "data": "date" } ,
 ...
 $('#getAtt').click(function(){
      ...
      "scrollX": true,                  
       "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/Onleavereport?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
                 "columns": [
               { "data": "Name" },
          { "data": "shift" },
          { "data": "date" } ,
