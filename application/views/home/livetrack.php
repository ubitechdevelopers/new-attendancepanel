  ...
  z-index: 2000;
   ...
   <body>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="row" style="margin-left: 0px;">
                                <span class="active5"> <a href="<?= URL; ?>location/livetrack" class="subhead">Live </a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
	...
	<div class="row">
					...
					<div class="col-sm-6" style="position: relative;right: 12px;">
               ...
               <select id='accuracy' onchange="myFunction()" style="width: 22rem;height: 36px;position: relative;right: 11px;">
  ...
  var randomColorBg = "#" + randomColor;
	...
	return this.infowindow.open(map, this);
		 ...
		 var endMarker = new google.maps.Marker({
            position: center,
            map: map,            
            icon: '<?php echo URL1?>assets/image/location_pin_svg.svg'
			//zoom:.8
        });
		...
		var startMarker = new google.maps.Marker({
            ...
            icon: '<?php echo URL1?>assets/image/location_pin_svg2.svg',
