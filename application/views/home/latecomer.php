   ...
   <body>
          ...
          <div id="heading2" class="sticky" style="z-index: 500; padding-bottom: 30px;">
                        ...
                        <div class="col-lg-11">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"><span class="active5"><a href="<?= URL; ?>Attendance/latecomer" class="subhead" style="margin-left:70px;">Late Comers</a></span></div>
            ...
            <thead>
                        ...
                        <tr>
                         ...
                         <th class="text-left" style="margin-right:20%;">Name</th>
                          
                         <th class="text-left">Date</th>
                         <th class="text-left" style="margin-left:20%;">Shift </th>
                         <th class="text-left" style="margin-left:20%;">Time In </th>
                         <th  style=" text-align:end;">Late By </th>
                         <th style=" text-align:end;"> Employee Code</th>
                         <th style=" text-align:end;">Designation</th>
                         <th style=" text-align:end;">Department</th>
                         <th style=" text-align:end;">Device</th>
                        </tr>
                      </thead>   
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                      <!--  <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Checkbox</label><br> -->
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk1" disabled >&nbsp;Date</label><br>
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk2" disabled >&nbsp;Shift</label><br>
                                      


                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled>&nbsp;TimeIn</label><br>
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" disabled>&nbsp;LateBy</label><br>
                                      
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk5" >&nbsp;Employee code</label><br> 
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6" >&nbsp; Designation</label><br>
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk7" >&nbsp;Department </label><br> 
    ...
    <?php 
      ...
      $('#filtermodal').modal('show');
         ...
         title: 'LateComers of '+org+' Dated '+isoDateString+'',
         ...
         "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getLatereport?datestatus="+1,
                 "columns": [
      ...
      $('#filtermodal').modal('show');
        ...
        buttons:[{ 
         ...
         "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getLatereport?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
                 "columns": [
...
$.LoadingOverlay("hide", true);
    ...
    <script type="text/javascript">
            $('.swiper-wrapper').on('click', 'span', function () {
                $('.swiper-wrapper span .active5').removeClass('active5');
                $(this).addClass('active5');
            });
            
//            
//            $(".swiper-wrapper").on("click", function(){
//   $("span").find(".active5").removeClass("active5");
//   $(this).addClass("active5");
//});
