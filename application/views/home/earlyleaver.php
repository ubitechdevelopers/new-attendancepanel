        ...
        <div class="col-lg-11">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide"><span class="active5"><a href="<?= URL; ?>Attendance/earlyleaver" class="subhead" style="margin-left:70px;">Early Leavers</a></span> </div>
            ...
            <table id="example" class="table" style="width:100%;">
               <thead>
                  <tr>
                     ...
                     <th  width="" class="text-left">Date</th>
                      <th width="" class="text-left">Shift </th>
                        <th width=""  class="text-left">Time Out </th>
                         <th  width=""  class="text-left">Early By </th>
                        ...
                        <div class="modal-body">
                            <div class="form-group" >
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled >&nbsp;tTimeOut</label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" disabled >&nbsp;EarlyBy</label><br>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6" >&nbsp;Department </label><br> 
                                          ...
                                          <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk7" >&nbsp;Employee code</label><br>
...
'bDestroy':true,	  
    lengthMenu: [[10,25,50, 100,500,1000], [10,25,50, 100,500,1000]],  
      ...
      title: 'EarlyLeavers of '+org+' Dated '+isoDateString+'',
      ...
      "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
       ...
       "contentType": "application/json",
              "ajax": "<?=  URL;?>Attendance/getearlyreport?datestatus="+1,
              "columns": [
...
'bDestroy':true,	  
   lengthMenu: [[10,25,50, 100,500,1000], [10,25,50, 100,500,1000]],  
      ...
      "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
       ...
       "contentType": "application/json",
              "ajax": "<?=  URL;?>Attendance/getearlyreport?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
              "columns": [
