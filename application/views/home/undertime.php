 ...
 position: sticky!important;
                        ...
                        <div class="col-lg-11">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"><span class="active5"><a href="<?= URL; ?>Attendance/undertime" class="subhead" style="margin-left:70px;">Undertime</a></span></div>
                        ...
                        <div class="modal-body">
                            <div class="form-group" >
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                      <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled >&nbsp;Undertime</label><br>
  ...
  <?php 
     ...
     buttons:[{ 
      ...
      title: 'Undertime of '+org+' Dated '+isoDateString+'',
     ...
     "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getundertimereport?datestatus="+1,
                 "columns": [
      ...
      "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getundertimereport?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
                 "columns": [
