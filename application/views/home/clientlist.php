...
<body>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control alpha1" id="companyname" value="" name="Name"
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control alpha1" id="contactperson" value="" name="Name"
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control alpha1" id="address" value="" name="Name"
                        ...
                        <br>
                        <div class="right">
                            <button type="button" class="btn btn-light bttn fit" onClick="refreshPage()" data-dismiss="modal">Cancel</button>
                            &nbsp;&nbsp;
    ...
    <div class="modal fade" id="printemp" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Clientsettings/clientlist"><i class="fa fa-chevron-left"
                                style="font-size: 1rem;"></i>&nbsp;&nbsp;&nbsp;Import Client</a></h5>
                    <img src="<?= URL ?>../assets/img/help-circle.svg" style="margin-left:35rem;">
					<div class="popshow " >
    ...
    <!-- ##################################################################################################-->
    <div class="modal fade" id="register-form" style="overflow: auto;" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" >
    ...
    <div class="modal fade" id="addClientE" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><a class="a" href="#" class="close" data-dismiss="modal"
                            aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Update Client
                            </a></h5>
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group label">
                                    ...
                                    <input type="varchar" id="companyE" class="form-control alpha1" required autocomplete="off">
                            ...
                            <div class="col-md-6">
                                <div class="form-group label">
                                    <label class="control-label" id="FNLable"> Contact Person<span
                                            style="color:red">*</span></label>
                                    <input type="varchar" id="firstNameE" class="form-control alpha1" required autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group label">
                                    ...
                                    <input type="text" class="form-control alpha1" id="addrE" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9" style="text-align: end;">
                            <button type="button" data-dismiss="modal" class="closeE btn btn-light bttn fit">Cancel</button>
