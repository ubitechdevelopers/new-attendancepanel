...
div.sticky.active {
  ...
  .flex-wrap {
   ...
   <body>
      <?php 
         ...
         ?>
      <main class="main" style="width: 83%;">
                        ...
                        <div class="col-lg-11">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/notreport"  class="subhead" style="margin-left:70px;">Not Reported</a></span></div>
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/latecomer" class="subhead" style="margin-left:70px;">Late Comers</a></span></div>
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/earlyleaver" class="subhead" style="margin-left:70px;">Early Leavers</a></span> </div>
                                    <div class="swiper-slide"> <span><a href="<?= URL; ?>Attendance/overtime" class="subhead" style="margin-left:70px;">Overtime</a></span></div>
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/undertime" class="subhead" style="margin-left:70px;">Undertime</a></span></div>
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/notsynced" class="subhead" style="margin-left:70px;">Not Synced</a></span></div>
                                    <div class="swiper-slide"> <span><a href="<?= URL; ?>Attendance/ontimeoff" class="subhead" style="margin-left:70px;">On Timeoff</a></span></div>
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/onleave" class="subhead" style="margin-left:70px;">On Leave</a></span></div>
                                    <div class="swiper-slide"><span class="active5"><a href="<?= URL; ?>Attendance/disapproved" class="subhead" style="margin-left:70px;">Disapproved & Approved</a></span></div>
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/attregister" class="subhead" style="margin-left:70px;">Attendance Register</a></span></div>
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/deptsummary" class="subhead" style="margin-left:70px;">Department Summary</a></span></div>
                                    <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/customizedrept" class="subhead" style="margin-left:70px;">Customized Report</a></span></div>
                        ...
                        <div class="row">
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              ...
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled >&nbsp;Name</label><br>
                                ...
                                <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk1" disabled >&nbsp; Time In</label><br>
                                 <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk2" disabled>&nbsp;Time Out</label><br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled >&nbsp; Disapproved</label><br>
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              ...
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" disabled>&nbsp;Reason For Disapproval</label><br>
                               <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk5" disabled >&nbsp;Remark For Disapproval</label><br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6" disabled>&nbsp;Remark for Approval </label><br>
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              ...
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk8" >&nbsp;Time In Date </label><br>
                               <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk9" >&nbsp;Time Out Date </label><br>
                               <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk10" >&nbsp;Approved Date And Time </label><br>
							    <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk11" >&nbsp;Employee code</label><br>
	  ...
	  <!-- attendance Approve start-->
		<div class="modal fade" id="ApproveAtt" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><a class="a" href="<?= URL; ?>Attendance/allattendance"><i class="fa fa-chevron-left" style="font-size: 0.7rem;"></i>&nbsp;Approve Attendance</a></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
          ...
          <div class="modal-footer">
            ...
            <button type="button" id="unchk" class="btn btn-light bttn fit" data-dismiss="modal">Cancel</button>
            <button type="button" id="approveatt"  class="btn btn-success bttn fit" >Save</button>
          </div>
      ...
      <div class="modal fade" id="filtermodal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <label for="inputPassword" class="col-sm-4 col-form-label">Employees</label>
               <div class="col-sm-8">
               <select id="disl" class="form-control">
   ...
   <?php 
      ...
      title: 'Approve&Diapprove of '+org+' Dated '+isoDateString+'',
      ...
      "scrollX": true,                  
       ...
       "contentType": "application/json",
              "ajax": "<?=  URL;?>Attendance/getabsapprove?datestatus="+1+datestring,
              "columns": [
 ...
 $('#getAtt').click(function(){
      ...
      "scrollX": true,                  
       ...
       "contentType": "application/json",
              "ajax": "<?=  URL;?>Attendance/getabsapprove?date="+range+"&shift="+shift+"&dept="+dept+"&empl="+empl+"&desg="+desg+"&dis1="+dis1,
              "columns": [
   ...
   <script>
    ...
    processData: false,
    contentType: false,
    url: "<?php echo URL;?>attendance/approveattendance",
    data: formdata,
    datatype:"json",
    type:"post",
    success: function(result){
        ...
        if(result==1)
      {
        //alert("Attendance is approved & moved to Present List");
