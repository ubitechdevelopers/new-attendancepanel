            ...
            <div class="modal-content">
                ...
                <div class="modal-body"style="padding-top: 0px;padding-bottom: 0px;">
                    ...
                    <div class="modal-footer" style="border-top: none;">
                        <button class="btn btn-success fnt" id="map_fullview" style="width: 11rem; color: white;"  >View in Fullsite</button>

                     <button class="btn btn-success fnt" id="creategeoatt"style="width: 11rem; color: white;"  >Create GeoFence</button>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body"style="padding-top: 0px;padding-bottom: 0px;">
                    ...
                    <button class="btn btn-success fnt"id="creategeoatt1"style="width: 11rem; color: white;"  >Create GeoFence</button>
...
$(document).on('click', '.test', function() {
    ...
    // var checkinloc=encrypt(checkinloc1);
    // alert(checkinloc);
   // alert(latit);
...
$('#map_fullview').click(function() {
    ...
    window.open("http://maps.google.com/?q=" + latit);
    $('#locationmodal').modal('hide');

});

$('#creategeoatt').click(function() {
   
  
    window.open("<?= URL ?>Attendance/attcreategeofence/"+latitid+"/"+longiid+"/"+checkinloc);
