    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="row " id="addhead">
                <div class="col-6 col-sm-6 col-md-9 col-lg-10" ><a href="<?php echo URL; ?>Userprofiles/employeelist" ><img src="<?= URL ?>../assets/img/l-arrow.png" class="mb-1"><b class="addemp1 ml-3">Add Employee</b></i></a></div>

                <div class="col-6 col-sm-6 col-md-3 col-lg-2" data-toggle="modal" data-target="#inviteEmp" style="cursor:pointer; display:none;">
				<img src="<?= URL ?>../assets/img/user.png"><b id="self" class="ml-2">Self Registration</b></i></div>
            </div>
                    ...
                    <fieldset>
                        <div class="row">
                            ...
                            <div class="col-10  col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <img id="imageAdd" src="<?= URL ?>../assets/img/profile.png" style="height:120px;width:120px; " class="rounded-circle circle ml-3" alt="Cinque Terre"><br>
                                    <span id="pencil" class="btn1"> <img  src="<?= URL ?>../assets/img/pencil.png">&nbsp;&nbsp;Edit
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="firstName" id="firstName"  class="alpha" autocomplete="off" />
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ecode" id="ecode" autocomplete="off"/>
                                </div>
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="cont" id="cont" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="country" id="country">
                                ...
                                ?>
                            </select><img src="<?= URL ?>../assets/img/b-arrow.png" id="b-arrow">
                        </div><br>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" id="password" class="active" value="123456" title="Password is initially set. It can be changed later on by the Admin or the Employee" autocomplete="off"><i class="fa fa-eye-slash" id="pswrd"></i>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="doj" id="doj" class="datepicker"  style="padding: 8px;" autocomplete="off"  readonly="readonly">
                                </div>
                            </div></div>
							<br>
							<?php 
							...
							$orgid= $_SESSION['orgid'];
							//echo
							$addon= getAddonPermission($orgid,'Addon_BasicLeave');
							...
							{  ?>
							 <input type="number" name="entitledleave" id="entitledleave" value="<?php echo getLeave($orgid); ?>" max="120" min='0' autocomplete="off"/>
                                </div></div><?php }else{ ?>
								
                                    <input type="number" name="entitledleave" id="entitledleave" value="<?php echo getLeave($orgid); ?>" max="50" min='0' autocomplete="off"/>
                                </div></div><?php } ?>
								<br>

                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    <label for="balanceleave" class="form-label ">Entitled Leave This Year</label>
                                    <input type="text" name="balanceleave" id="balanceleave" disabled/>
                                </div></div></div>
								
							<?php }else{ ?>
							
							<input type="hidden" name="entitledleave" id="entitledleave" value="0" onkeypress="if (this.value.length == 2)
                                      return false;" max="50" min='0' autocomplete="off"/>
                                ...
                                $data = array("0" => "User", "2" => "Dept. Head", "1" => "Admin-for app only");
                                 foreach ($data as $key => $value) {
                                  ...
                                  ?>
                                    ...
                                    <img src="<?= URL ?>../assets/img/b-arrow.png" id="b-arrow">
