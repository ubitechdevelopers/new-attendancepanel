  ...
  .flex-wrap {
   ...
   <body>
                        ...
                        <div class="col-lg-11">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"><span  class="active5"><a href="<?= URL; ?>Attendance/deptsummary" class="subhead" style="margin-left:70px;">Department Summary</a></span></div>
     ...
     buttons:[{ 
      ...
      title: 'Department Summary of '+org+' Dated '+isoDateString+'',
