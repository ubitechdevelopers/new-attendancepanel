   ...
   <body>
      ...
      <main class="main" style="width: 83.7%;">
       <div id="heading2" class="sticky" style="z-index: 500; padding-bottom: 30px;">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="row" style="margin-left: 0px;">
                                ...
                                <span class="active5"><a href="<?= URL; ?>location/currentlocation" class="subhead">Current </a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;       
                                <span><a href="<?= URL; ?>location/getdistance"  class="subhead">Distance Travelled</a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="row">
            <div class="col-md-8">
               <div id="map" style="height:500px; margin-top:0px; border: 5px solid #e6dede;"  >
                  <hr/>
               </div>
            </div>
            <div class="col-md-4">
               <div class="row">
                  <div class="col-sm-6" style="position: relative;right: -136px;">
                     ...
                     <tbody>
                        <?php
                           ...
                           echo '<tr><td></td><td style="     background-color: white;"><b>No Data Found<b></td></tr>';
                                  ...
                                  <td ><span style="font-weight:bold;">'.$livetrackemp[$i]['name'].'</span><br><b style="font-size:11px;">Last known location:</b> <span style="font-size:11px;" id="emp'.$livetrackemp[$i]['empid'].'"></span></td>
  ...
  var randomColorBg = "#" + randomColor;
	...
	return this.infowindow.open(map, this);
		 ...
		 var endMarker = new google.maps.Marker({
            position: center,
            map: map,
            icon: '<?php echo URL1?>assets/images/icons8-user-location-40.png'
			//zoom:100
        });
		...
		var startMarker = new google.maps.Marker({
            ...
            icon: '<?php echo URL1?>assets/images/icons8-home-address-48.png',
...
//for(var j=0; j<contentString.length; j++){
	...
	if(alldata!=undefined || alldata!=null){
	 ...
	 var createGeocodeCallback = function(n,latlng,last){
    return function (results, status) {
	 ...
	 // alert(document.getElementById('#emp'+currentEmployeeId));
	   ...
	   var counter112 =1;
	   $.ajax({url: "<?php echo URL;?>location/getemppic",
						data: {"empid":n},
					success: function(result){
					//alert(JSON.parse(result.trim())[0]['ImageName']);
			...
			/* var ic = { 
					//url: JSON.parse(result.trim())[0]['ImageName'], // url
					url: 'http://ubiattendance.zentylpro.com/assets/images/icons8-user-location-40.png', // url
					scaledSize: new google.maps.Size(50, 50), // scaled size
					origin: new google.maps.Point(0,0), // origin
					anchor: new google.maps.Point(22, 94), // anchor
				    shape:{coords:[50,50,40],type:'circle'},
					optimized:false,
					title: 'spot'
					};
            ...
            icon: ic,
		 	 ...
		 	 //var cont112 =last+JSON.parse(result.trim())[0]['FirstName'];
		 	 var cont112 ='<div style="padding:2px;width:240px;background-color:white;box-shadow(0px 0px 5px rgba(129,129,129,0.2)) ">' +
                    '<b> Name:</b> ' +JSON.parse(result.trim())[0]['FirstName'] +'<br/>'+
'<b> Time:</b> ' +last+'</div>';
	...
	return this.infowindow.open(map, this);
			 ...
			 /* google.maps.event.addListener(endMarker, "mouseover", function(event) {
                      this.setIcon(ic);
                    });

                  google.maps.event.addListener(endMarker, "mouseout", function(event) {
                   this.setIcon();
                            }); */
	 ...
	 //var lastime =alldata[currentEmployeeId][currentdate][Object.keys(alldata[currentEmployeeId][currentdate]).length-1]
	 var lastime =alldata[currentEmployeeId][currentdate]
	 var last= Object.keys(lastime)[Object.keys(lastime).length-1];
	 ...
	 geocoder.geocode({ location: latlng }, createGeocodeCallback(currentEmployeeId,latlng,last)); 
