            ...
            <div id="heading2" class="sticky" style="z-index: 500; padding-bottom: 30px;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="primary-text">Leave</div>
...
<button id="btn-hide-all-children" type="button">Collapse All</button> -->
                ...
                <thead>
                    ...
                    <tr  data-toggle="collapse">
                      <!--  <th  width="10%">Employee Code</th>  -->
                        ...
                        <th  class="text-left">Approved/Rejected By</th>
                        ...
                        <div class="modal-body">
                            <div class="form-group" >
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk8" >&nbsp; Remarks</label><br>
        ...
        <div class="modal fade" id="ApproveLeave" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><a class="a" href="#" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Leave Status</a></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
			...
			var org = '<?php echo getOrgName($_SESSION['orgid']) ?>';
             ...
             var isoDateString = date.toISOString().substring(0, 10);
              ...
              $('#filtermodal').modal('show');
                    ...
                    "contentType": "application/json",
                    "ajax": "<?= URL; ?>Leave/leavereport?date=" + range + "&shift=" + shift + "&deprt=" + deprt + "&empl=" + empl + "&status=" + status,
                    "columns": [
                        {
