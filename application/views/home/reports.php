...
<html>
   ...
   <body ng-app = "adminapp"  ng-controller="attroasterCtrl" ng-init="fetchtablemonthlydata();fetchtablemonthlydata1();"   >
      ...
      <main class="main">
            ...
            <div class="row">
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="row" style="margin-left: 0px;">
                     <span class="active5"> <a href="<?= URL; ?>Report/" class="subhead">Employees Wise Summary</a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
                     <span ><a href="<?= URL; ?>Report/monthlyreports" class="subhead">Monthly Register</a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding-left: 22.3rem;">
                  <div class="row" style="margin: 0px; padding: 0px; ">
                     ...
                     <?php if($_SESSION['orgid'] == 70799 || 10)
                        {
                        ?>
                     <a class="tertiary-button" download="Monthlyreport.xls" href="#" onclick="return ExcellentExport.excel(this,'example1','Monthly Report');" class="dt-button buttons-excel buttons-html5" >
                        <div> <span class="side-item-icon" > <img src="<?= URL ?>../assets/icons/download.svg" alt=""> </span>Excel</div>
                     </a>
                     <?php }else {?>
                     <a class="tertiary-button" download="Monthlyreport.xls" href="#" onclick="return ExcellentExport.excel(this,'example','Monthly Report');" class="dt-button buttons-excel buttons-html5" >
                        <div> <span class="side-item-icon" > <img src="<?= URL ?>../assets/icons/download.svg" alt=""> </span>Excel</div>
                     </a>
                     <?php }?>
         ...
         <div class="row" style="    width: 68.5rem; padding-left: 12px;padding-right: 12px;">
            <div class="col-md-12 col-sm-12 col-xs-12" style="margin: 0px;padding: 0px;">
                                    ...
                                    <tr>
                                       <td>
                                          <table class="table table-striped table-hover" >
                                             <tr>
                                                <th class="name1"  style="padding-top:5px;padding-left:20px;">Date</th>
               ...
               <div data-pagination="" data-num-pages="numOfPages()" 
                  ...
                  data-boundary-links="true" style="margin-top: 1.5rem!important;"></div>
            </div>
         </div>
      ...
      <div class="modal fade" id="filtermodal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <button type="button" id="getAtt" ng-click="fetchtablemonthlydata();fetchtablemonthlydata1();" class="btn btn-success bttn fit " data-dismiss="modal">Save</button>
               </div>
               </div>
               </div>
               </div>
