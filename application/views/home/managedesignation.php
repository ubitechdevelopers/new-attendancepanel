   ...
   <body  ng-app ="adminapp"  ng-controller="attroasterCtrl">
         ...
         <div id="heading2" class="sticky" style="z-index: 500; padding-bottom: 30px;">
            ...
            <div class="row">
               <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
			    ...
			    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 shinigami">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form>
                     ...
                     <div>This Designation is inactive. Change the status to Active to assign it to employees.</div>
                     <div class="clearfix"></div>
                  </form>
                  <br>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-9" style="text-align: end;">
                        <div class="right">
                           ...
                           <button type="button"  class="btn btn-light bttn  bttn mx-2" data-dismiss="modal" style="color:#808080;">Close</button>
                        </div>
                     </div>
                  </div>
               </div>
    ...
    <a href=""><p style="color:black;">Help</p>
						...
						<li>The format of the data in the import file should be same as the sample file. </li>
							...
							<li>Designation, Designations & Shifts should be added in the panel before importing. </li>
							...
							<li>You must fill all mandatory fields ( Full Name, Contact No., Shift, Designation & Designation).
							</li>
               ...
               <div class="modal-body">
                  <form id="upload_csv" method="post" enctype="multipart/form-data">
                     ...
                     <div class="row">
                        ...
                        <div class="col-8 mt-3" style="margin-left:-5%;" >
                           <button type="button" class="btn" style="border-color: #E5E5E5;"><a href="<?php echo IMGURL5; ?>../assets/newdesignation.csv" style="color:rgba(122, 122, 122, 1); "><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>Download Sample</a></button>
                        </div>
                        <div class="col-4"></div>
                     </div> 
                     <div class="row">
                       
                        <div class="col-8 mt-3  mb-3" style="margin-left:-10%;">
               ...
               <div class="modal-footer">
                  <div class="showresult" style="display:none;">
                     <p style="margin-left: -245%;" >Total records : <span id="repeatemp"></span></p>
                     <p style="margin-left: -245%;" >Total inserted records : <span id="importemp"></span></p>
                     <a  style="margin-left: -250%;" href="<?php echo URL; ?>admin/showTMPDes/1" class="btn btn-link">show insufficient record</a>
                  </div>
               </div>
            </div>
            <div id="response"></div>
                    ...
                    },
                        {
                            ...
                            exportOptions: {
                              ...
                              repeatingHead: {
                                  ...
                                  title: 'Designation of ' + org + ' Dated ' + isoDateString + '',
      ...
      $("#savedesg").click(function () {
          ...
          $.ajax({
              ...
              success: function (response) {
                //   alert(response);
                if(response>1){
                    doNotify('top', 'center', 4, 'Designation name already exit');
                    return false;
                   }
                   else{
                  ...
                  success: function (result) {
                      ...
                      if (obj["sts"] == "true") {
                          ...
                          if(totlemp>0){
                                ...
                                doNotify('top', 'center', 4, 'Designation already exit');
                                }
   ...
   <script>
    $('#getAtt').click(function() {
      ...
      "orderable": false
           ...
           "contentType": "application/json",
           "ajax": "<?=  URL;?>Managesettings/getAllDesg1?&statusfilter=" + statusfilter,
              "columns": [
                  {"data": "name"},
                  //  { "data": "desc" },
                  //{ "data": "cdate" },
