...
.dt-button-collection .dropdown-menu{
   ...
   <body>
      ...
      <div id="heading2" class="sticky" style="z-index: 500; padding-bottom: 30px;">
                        ...
                        <div class="col-lg-11">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"><span class="active5"><a href="<?= URL; ?>Attendance/notreport"  class="subhead"  style="margin-left:70px;">Not Reported</a></span></div>
            ...
            <thead>
                        <tr>
                          <th style="margin-right:20%" >Employee Code</th>
                          <th style="margin-left:20%">Name</th>
                          <th >Designation</th>
                            ...
                            <div class="form-group" >
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled>&nbsp;Device</label><br>

                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" >&nbsp; Date</label><br>

                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk5" >&nbsp;Department </label><br> 
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6" >&nbsp;Shift</label><br>

                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk7" >&nbsp;Reason</label><br>

                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk8" >&nbsp;Remark</label><br>
   ...
   <?php 
      ...
      action: function myexcel() {
        ...
        $('#column_modal').modal('show');
         ...
         title: 'NotReported of '+org+' Dated '+isoDateString+'',
         ...
         'serverMethod': 'post', 
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getNotReportedEmp?datestatus="+1,
                 "columns": [
                 { "data": "code" },
            { "data": "FirstName" },  
            { "data": "desg" },
      ...
      action: function myexcel() {
        ...
        buttons:[{ 
         ...
         "scrollX": true,                  
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getNotReportedEmp?shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
                 "columns": [
                 { "data": "code" },
            { "data": "FirstName" },  
            { "data": "desg" },
