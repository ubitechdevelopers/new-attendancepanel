  ...
  .flex-wrap {
   ...
   <body>
                        ...
                        <div class="col-lg-11">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"><span  class="active5"><a href="<?= URL; ?>Attendance/attregister" class="subhead" style="margin-left:70px;">Attendance Register</a></span></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                      <!--  <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Checkbox</label><br>-->
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Employee code</label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk1" disabled >&nbsp;Employee Name</label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk2" disabled>&nbsp;phone No</label><br>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
									  <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled>&nbsp;Present Days</label><br>
                                      <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" disabled >&nbsp;Absent Days </label><br>
                                      <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk5" disabled>&nbsp;Late Marks off</label><br>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6" disabled >&nbsp;Week Off</label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk7" >&nbsp; Location</label><br>
										 <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk8" >&nbsp;Department </label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk9" >&nbsp;Designation </label><br>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
              ...
              <!--  <select id="shift" class="form-control ">
               ...
               <select class="form-control" style="border: 1px solid #ced4da;">  id="areaAssign" <?php if($permis==0) echo "disabled"; ?> >
     ...
     <?php 
      ...
      title: 'Attendance Register of '+org+' Dated '+isoDateString+'',
      ...
      "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getregister",
                 "columns": [
 ...
 $('#getAtt').click(function(){
      ...
      "scrollX": true,                  
       "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getregister?date="+range+"&empl="+empl+"&dept="+dept+"&desg="+desg+"&area="+area,
                 "columns": [
				{ "data": "code" },
                { "data": "name" },
                { "data": "contect" },
