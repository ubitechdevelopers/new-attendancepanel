...
<html>
   <head>
     ...
     <meta charset="utf-8">
       ...
       ?>
    <link rel="stylesheet" href="<?= URL ?>../assets/new_bootstrap_select/css/bootstrap-select.min.css">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <?php 
     ...
     <!-- <script src="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.18/dist/js/bootstrap-select.min.js"></script>-->
        ...
        <script type="text/javascript" src="<?= URL ?>../assets/new_bootstrap_select/js/bootstrap-select.min.js"></script>
