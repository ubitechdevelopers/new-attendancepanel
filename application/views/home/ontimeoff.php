...
div.sticky.active {
 ...
 position: sticky!important;
                        ...
                        <div class="col-lg-11">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"> <span class="active5"><a href="<?= URL; ?>Attendance/ontimeoff" class="subhead" style="margin-left:70px;">On Timeoff</a></span></div>
                            ...
                            <div class="form-group" >
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                      <!--  <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Checkbox</label><br>-->
                                       ...
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Employee code</label><br>
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled >&nbsp;Date</label><br>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
									 ...
									 <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" disabled >&nbsp;Reason </label><br>
									 
                                      <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk5" >&nbsp; Designation</label><br>
                                      
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6" >&nbsp; Department</label><br>
                                       
                                        
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk7" >&nbsp;From </label><br> 
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                       ...
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk8" >&nbsp;From Location </label><br>
									   
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk9" >&nbsp;To</label><br>
										
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk10" >&nbsp;To Location</label><br>
										
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk11" >&nbsp;Duration</label><br>
  ...
  <?php 
      ...
      title: 'OntimeOff of '+org+' Dated '+isoDateString+'',
      ...
      "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/Timeoffreport",
                 "columns": [
               { "data": "code" }, 
          { "data": "Name" },
            { "data": "shift" },
 ...
 $('#getAtt').click(function(){
      ...
      "scrollX": true,                  
       "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/Timeoffreport?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
                 "columns": [
				 { "data": "code" },
                  { "data": "Name" },
            { "data": "shift" },
