        ...
        <main class="main">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
						 ...
						 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mishi" >
						 <button class="primary-button" data-toggle="modal" data-target="#myModal" style="margin-right=220%;">
						 ...
						 <button class="tertiary-button" data-toggle="modal" data-target="#printemp">
                            <div> <span class="side-item-icon" > <img src="<?= URL ?>../assets/icons/download.svg" alt=""> </span>Import Dept </div>   
                        </button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                     <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Checkbox</label><br>
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" >&nbsp; Department</label><br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk1" >&nbsp;Department Head </label><br>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk2" >&nbsp; Status</label><br>
...
<!-----delete dept close--->
  ...
  <div class="modal fade" id="delDept" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="clearfix"></div>
                    ...
                    <hr style="width:100%">
                    <button type="button" id="delete" class="btn btn-success bttn mx-2">Delete</button>
                    <button type="button"  class="btn btn-light  bttn" style="color:black; " data-dismiss="modal">Close</button>
                    </div>
                    </div> 
                  </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <img src="<?= URL ?>../assets/img/help-circle.svg" style="margin-left:32rem;">
						  <div class="popshow " >
    <a href=""><p style="color:black;">Help</p>
                    ...
                    <div class="modal-body">
                        <form id="upload_csv" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 mt-4 ml-3">
                                    <button type="button" class="btn " style="border-color: #E5E5E5;"><a href="<?php echo IMGURL5; ?>../assets/newdepartment.csv" style="color:rgba(122, 122, 122, 1); "><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg> Download Sample</a></button>
                                </div>
                                <div class="col-4"></div>
                            </div>
                            <div class="row">
                            <div class="col-2"></div>
                               ...
                               <input type="submit" id="btn1" class="btn btn-success btnfile importdepp" value="Next" disabled style="display: none;">
                    ...
                    <div class="modal-footer">
                            <div class="showresult" style="display:none;">
                                            <p style="margin-left: -252%;" >Total records : <span id="repeatemp"></span></p>
                                            <p style="margin-left: -252%;">Total inserted records : <span id="importemp"></span></p> 
                                            <a style="margin-left: -256%;" href="<?php echo URL; ?>Managesettings/showTMPDep/2" class="btn btn-link">show insufficient record</a>
                                        </div>                         </div>
                </div>
                <div id="response"></div>
            </div>
        ...
        $("#save12").click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                   // alert(response)
                   if(response>1){
                    doNotify('top', 'center', 4, 'Department name already exit');
                    return false;
                   }
                   else{
...
<script>
    ...
    <script>
        $("#upload_csv").on("click",'.importdepp', function(event) {
                    ...
                    success: function (result) {
                        ...
                        if (obj["sts"] == "true") {
                            ...
                            if(totlemp>0){
                                ...
                                doNotify('top', 'center', 4, 'Department already exit');
                                }
...
//                      buttons: [
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Managesettings/getAllDept1?&statusfilter=" + statusfilter,
