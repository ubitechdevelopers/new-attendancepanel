<?php
       ...
       $searchQuery = "";
   	 ...
   	 if($searchQuery != '')
          ...
          <div class="dropdown">
           ...
           data-name="'.$row->Name.'" 
           data-sts="'.$row->archive.'"
           data-assign="'.departmentAssignAll($row->Id).'"><i class="fa fa-pencil  material-icons" style="font-size:10px; margin:0px 8px 0px 6px;color:yellow; "  title="Edit"></i><a href="#" style="color:black; font-size:13px; margin-left:5px;">Edit</a></li>
       ...
       public function getAllHolidays($postData = null) {
               ...
               if($row->fromDate > date("Y-m-d"))
          {
               ...
               $data['action'] = '<div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 6.3rem; height:6.5rem; border-radius:5px; padding: 0.7rem 0.5rem 0.5rem 0.5rem;margin-left:-25%">
                                  <li class="edit" style="height:30px;" data-toggle="modal" data-target="#edit"  
              data-sid="'.$row->Id.'"
           data-sid="'.$row->Id.'" 
           data-name="'.$row->Name.'" 
           data-from="'.date("m/d/Y", strtotime($row->fromDate)).'" 
           data-to="'.date("m/d/Y", strtotime($row->DateTo)).'" 
           data-description="'.$row->Description.'"><i class="fa fa-pencil  material-icons" style="font-size:16px; margin:0px 8px 0px 6px;"  title="Edit"></i><a href="#" style="color:black; font-size:13px; margin-left:5px;">Edit</a></li>
   
           <li class="delete" style="height:30px;" data-toggle="modal" data-target="#delete"  
   ...
   else
          {
               $data['action'] = '<div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 6rem; border-radius:5px; padding: 0.7rem 0.5rem 0.5rem 0.5rem;margin-left:-25%">
                                  <li class="edit cant12" style="height:30px;" data-toggle="modal" data-target=""  
              data-sid="'.$row->Id.'"
           data-sid="'.$row->Id.'" 
           data-name="'.$row->Name.'" 
           data-from="'.date("m/d/Y", strtotime($row->fromDate)).'" 
           data-to="'.date("m/d/Y", strtotime($row->DateTo)).'" 
           data-description="'.$row->Description.'"><i class="fa fa-pencil  material-icons" style="font-size:16px; margin:0px 4px 0px 3px;"  title="Edit"></i><a href="#" style="color:black; font-size:13px; margin-left:5px;">Edit</a></li>
   
           <li class="delete cant23" style="height:30px;" data-toggle="modal" data-target=""  
              data-sid="'.$row->Id.'" data-sname="'.$row->Name.'" ><i class="fa fa-trash" style="font-size:16px; margin:0px 4px 0px 3px;"  data-sid="'.$row->Id.'" data-sname="'.$row->Name.'"  title="Delete Client"></i> <a href="#" style="color:black; font-size:13px; margin-left:5px;">Delete</a></li> 
       ...
       public function getAllrates($postData = null) {
           ...
           foreach ($query->result() as $row) {
            ...
            $data['action'] = '<div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 6.3rem;  border-radius:5px; padding: 0.7rem 0.5rem 0.5rem 0.5rem;margin-left:-25%">
                                  <li class="edit" style="height:30px;" data-toggle="modal" data-target="#addDesgE"  
              data-sid="'.$row->Id.'"
           data-did="'.$row->Id.'" 
           data-name="'.$row->Name.'" 
           data-sts="'.$row->status.'"
           data-rate="'.$row->Rate.'"
           data-attsts="'.$attsts.'"><i class="fa fa-pencil  material-icons" style="font-size:16px; margin:0px 8px 0px 6px;"  title="Edit"></i><a href="#" style="color:black; font-size:13px; margin-left:5px;">Edit</a></li>
   
           <li class="delete" style="height:30px;" data-toggle="modal" data-target="#delDesg"  
              data-did="'.$row->Id.'" 
           data-na="'.$row->Name.'"
           data-rate="'.$row->Rate.'"><i class="fa fa-trash" style="font-size:16px; margin:0px 8px 0px 6px;"  data-did="'.$row->Id.'" 
           data-na="'.$row->Name.'"
           data-rate="'.$row->Rate.'" title="Delete Client"></i> <a href="#" style="color:black; font-size:13px; margin-left:5px;">Delete</a></li> 
              </ul>
                  </div> '; 
   ...
   $data['action'] = '<div class="dropdown">
           ...
           data-attsts="'.$attsts.'" 
           data-radius="'.number_format((float)$row->Radius, 2, '.', '').'" 
           data-sts="'.$row->Status.'"><i class="fa fa-pencil  material-icons" style="font-size:16px; margin:0px 8px 0px 6px;"  title="Edit"></i><a href="#" style="color:black; font-size:13px; margin-left:5px;">Edit</a></li>
   
           <li class="delete" style="height:30px;" data-toggle="modal" data-target="#delDept"  
              data-did="'.$row->Id.'" data-dname="'.$row->Name.'"><i class="fa fa-trash" style="font-size:16px; margin:0px 8px 0px 6px;"  data-did="'.$row->Id.'"  data-did="'.$row->Id.'" data-dname="'.$row->Name.'" title="Delete"></i> <a href="#" style="color:black; font-size:13px; margin-left:5px;">Delete</a></li> 
   
               <li class="upGeolocation" style="height:30px;" data-toggle="modal" data-target="#updateGeolocation"  
             onclick="angular.element(this).scope().GetEmpList1(\''.$row->Id.'\')" 
          data-sid="'.$row->Id.'" data-sname="'.$row->Name.'" ><i class="fa fa-trash" style="font-size:16px; margin:0px 8px 0px 6px;"  onclick="angular.element(this).scope().GetEmpList1(\''.$row->Id.'\')" 
