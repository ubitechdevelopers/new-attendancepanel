        ...
        foreach ($query->result() as $row)
        {
           ...
           $data['shift'] = '<span title="Shift Timing: ' . getShiftTimes($row->ShiftId) . ', Break Hours:' . getShiftBreaks($row->ShiftId) . '">' . getShift($row->ShiftId) . '</span>';
            ...
            if ($name != "")
            {
                ...
                if ($row->ExitImage == '')
                {
                    $data['exitimg'] = $data['entryimg'] = '<img src="' . URL . "../assets/image/user_png.png" . '"  style="width:70px!important;height:90px!important;object-fit: cover; "  />';;
                }
                else
                {
...
<a style="font-size:11px;"  title="' . $row->CheckOutLoc . '">' . $row->CheckOutLoc . $data['positionout'] . '</a></span>';
                ...
                {
                    $attn = '<div style="background-color:green;text-align:center;color:white;padding: 5px 20px 5px 20px;border-radius:100px;" title="Halfday">Halfday</div>';
                }
                elseif ($row->Wo_H_Hd == 13 and $row->AttendanceStatus == 1)
                {
                    $attn = '<div style="background-color:#F2C94C;text-align:center;color:white;padding: 5px 20px 5px 20px; border-radius:100px;" title="Half Present">Half Present</div>';
                }

                else
                {
                    $attn = $row->AttendanceStatus != 2 ? '<div style="padding: 5px 20px 5px 20px;background-color: #219653;text-align:center;color:white; border-radius:100px;" title="Present">present</div>' : '<div style=" background-color:#f15353;text-align:center;color:white;padding-left:6px;
padding-right:6px;border-radius:100px;" title="Absent">Absent</div>';
                }

                if ($row->AttendanceStatus == 7 && $row->Wo_H_Hd == 11)
                {
                    $attn = '<div style="background-color:#FFAC33;text-align:center;color:white;padding: 5px 20px 5px 20px; border-radius:100px;" title="WeekOff">WeekOff</div>';
                }
                else if ($row->AttendanceStatus == 7 && $row->Wo_H_Hd == 12)
                {
                    $attn = '<div style="background-color:#FFAC33;text-align:center;color:white;padding: 5px 20px 5px 20px; border-radius:100px;" title="Holiday">Holiday</div>';
                }
          ...
          <li class="q3" style="height:30px;" ><i class="fa fa-clock-o" style="font-size:16px; margin:0px 8px 0px 6px;"  title="View"></i> <a href="' . URL . 'attendance/viewflexiattendance/' . $row->EmployeeId . '/' . $row->Id . '" style="color:black; font-size:13px; margin-left:5px;">View</a></li>
                        ...
                        <!-- three dots -->
                            ...
                            <li class="track_loc" style="height:30px;"><i class="track_loc fas fa-walking" style="font-size:16px; margin:0px 8px 0px 6px;"    title="No Punched visits"></i> <a href="trackLocations/' . $row->EmployeeId . '/' . $row->AttendanceDate . '/' . substr($row->TimeIn, 0, 5) . '/' . substr($row->TimeOut, 0, 5) . '/' . $data['wh'] . '" target="_self" style="color:black; font-size:13px; margin-left:5px;">No Punched visits</a></li>
        ...
        foreach ($query->result() as $row)
        {
            ...
            if ($name != "")
            {
             ...
             //  $data['test'] = '<i class="fa fa-map-marker fa-2x" style="margin-left:0.5rem;color:#80CF7F;" data-target="#locationmodal"  data-toggle="modal"  title="' . $row->checkInLoc . '" data-toggle="tooltip" data-placement="top"></i>';
                ...
                $data['truh'] = '<span  class="loc test" data-toggle="modal" data-target="#locationmodal" data-id="' . $row->EmployeeId . '"  data-latit="' . $row->latit_in . ',' . $row->longi_in . '" data-latitin="' . $row->latit_in . '" data-longiin="' . $row->longi_in . '" ><img src="' . URL . "../assets/icons/withgeo.svg" . '"  style="width:28.33px!important;height:28.33px!important;"title="' . $row->checkInLoc . '"/></span>';


                $data['ti'] = substr($row->TimeIn, 0, 5) . '<br>' . $data['truh'];
...
<a style="font-size:11px;"  title="' . $row->CheckOutLoc . '">' . $row->CheckOutLoc . $data['positionout'] . '</a></span>';
                ...
                else
                {
                    ...
                    $attn = $row->AttendanceStatus != 2 ? '<div style="text-align:center;color:white;padding: 5px 20px 5px 20px;background-color: #219653; border-radius:100px;" title="Present">present</div>' : '<div style=" background-color:#f15353;text-align:center;color:white;padding: 5px 20px 5px 20px; border-radius:100px;" title="Absent">Absent</div>';
                }
...
data-shifttype="' . $shiftype . '";
 data-attendancedate="' . $row->AttendanceDate . '";><i class="fa fa-pencil  material-icons" style="font-size:16px; margin:0px 8px 0px 6px;"  title="Edit"></i><a href="#" style="color:black; font-size:13px; margin-left:5px;">Edit</a>
  ...
  <li class="t7 delete" style="height:30px;" data-toggle="modal" data-target="#delAtttimein"  data-aid="' . $row->Id . '" data-aname="' . $emp_name . '" data-attdate="' . $row->AttendanceDate . '" 
             data-timein="' . date("H:i", strtotime($row->TimeIn)) . '"><i class="fa fa-trash" style="font-size:16px; margin:0px 8px 0px 6px;"   title="Delete"></i> <a href="#" style="color:black; font-size:13px; margin-left:5px;">Delete</a></li>
...
data-shifttype="' . $shiftype . '";><i class="fa fa-pencil  material-icons" style="font-size:16px; margin:0px 8px 0px 6px;"  title="Edit"></i><a href="#" style="color:black; font-size:13px; margin-left:5px;">Edit</a>
  ...
  <li class="t1 delete" style="height:30px;" data-toggle="modal" data-target="#delAtttimein"  data-aid="' . $row->Id . '" data-aname="' . $emp_name . '" data-attdate="' . $row->AttendanceDate . '" 
             data-timein="' . date("H:i", strtotime($row->TimeIn)) . '"><i class="fa fa-trash" style="font-size:16px; margin:0px 8px 0px 6px;"   title="Delete"></i> <a href="javascript:;" style="color:black; font-size:13px; margin-left:5px;">Delete</a></li>
...
data-attendancedate="' . $row->AttendanceDate . '";><i class="fa fa-pencil  material-icons" style="font-size:16px; margin:0px 8px 0px 6px;"  title="Edit"></i><a href="#" style="color:black; font-size:13px; margin-left:5px;">Edit</a>
  ...
  <li class="4test delete" style="height:30px;" data-toggle="modal" data-target="#delAtt"   data-aid="' . $row->Id . '" data-aname="' . $emp_name . '" data-attdate="' . $row->AttendanceDate . '" 
             data-timein="' . date("H:i", strtotime($row->TimeIn)) . '"><i class="fa fa-trash" style="font-size:16px; margin:0px 8px 0px 6px;"  title="Delete"></i> <a href="javascript:;" style="color:black; font-size:13px; margin-left:5px;">Delete</a></li>
                        ...
                        else
                        {
                            $data['action'] = '  <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 10.5rem; height:6.5rem; border-radius:5px; padding: 0.7rem 0.5rem 0.5rem 0.5rem;margin-left:-120%">
                                  ...
                                  <li class="5test delete" style="height:30px;" data-toggle="modal" data-target="#delAttnew"  data-aid="' . $row->Id . '" data-aname="' . $emp_name . '" data-attdate="' . $row->AttendanceDate . '"
             data-timein="' . date("H:i", strtotime($row->TimeIn)) . '"><i class="fa fa-trash" style="font-size:16px; margin:0px 8px 0px 6px;"    title="Delete"></i> <a href="javascript:;" style="color:black; font-size:13px; margin-left:5px;">Delete</a></li>
        ...
        if ($currentdatestatus == 1)
        {
            ...
            foreach ($query->result() as $row)
            {
                ...
                $data['shift'] = '<span title="Shift Timing: ' . getShiftTimes($row->ShiftId) . ', Break Hours:' . getShiftBreaks($row->ShiftId) . '">' . getShift($row->ShiftId) . '</span>';
                $emp_name = getEmpName($row->EmployeeId);
                $data['name'] = '<span style="color:#000000;">'.ucwords($emp_name) .'</span>'. '<br>' . $data['shift'];
                ...
                if ($checkleavestatus == $row->EmployeeId)
                {
                    ...
                    $attn = '<div style=" background-color:#4ddbff;text-align:center;color:white;padding: 5px 20px 5px 20px;border-radius:100px;" title="Leave">Leave</div>';
                }
                else
                {
                    if ($row->ctin < $time && $row->AttendanceDate == $today)
                    {
                        $attn = '<div style=" background-color:#f15353;text-align:center;color:white;padding: 5px 20px 5px 20px; border-radius:100px;" title="Absent">Absent</div>';
                    }
                }
...
<a style="font-size:11px;"  title="' . $row->CheckOutLoc . '">' . $row->CheckOutLoc . $data['positionout'] . '</a></span>';
                ...
                elseif ($row->Wo_H_Hd == 13 and $row->AttendanceStatus == 1)
                {
                    $attn = '<div style="text-align:center;color:white;padding: 5px 20px 5px 20px;background-color: #F2C94C; border-radius:100px;" title="Half Present">Half Present</div>';
                }

                else
                {
                    $attn = $row->AttendanceStatus != 2 ? '<div style="padding: 5px 20px 5px 20px;background-color: #219653;text-align:center;color:white;border-radius:100px;" title="Present">present</div>' : '<div style=" background-color:#f15353;text-align:center;color:white;border-radius:100px;" title="Absent">Absent</div>';
                }
...
data-attendancedate="' . $row->AttendanceDate . '";><i class="fa fa-pencil  material-icons" style="font-size:16px; margin:0px 8px 0px 6px;"  title="Edit"></i><a href="#" style="color:black; font-size:13px; margin-left:5px;">Edit</a>
    ...
    public function getAbsent__new()
    {
        ...
        foreach ($dateRange as $date)
        {
            ...
            else
            {
                ...
                $query = $this
                    ->db
                    ->query("Select A.device,E.Id,E.EmployeeCode,A.EmployeeId,A.AttendanceDate,A.ShiftId,(CASE WHEN (E.Id IN (SELECT empid FROM ShiftPlanner WHERE ShiftPlanner.ShiftDate='" . $range . "' And ShiftPlanner.orgid=" . $org_id . " And ShiftPlanner.empid=E.Id)) THEN (SELECT shiftid FROM ShiftPlanner WHERE ShiftPlanner.ShiftDate='" . $range . "' And ShiftPlanner.orgid=" . $org_id . " And ShiftPlanner.empid=E.Id) ELSE E.Shift END) as newshift ,(select disapp_sts from Disapprove_approve where Disapprove_approve.EmployeeId=E.Id And Disapprove_approve.disapp_sts=0 AND Disapprove_approve.AttendanceDate='" . $range . "' limit 1) as DisapproveStatus, (select disapp_reason from Disapprove_approve where Disapprove_approve.EmployeeId=E.Id And Disapprove_approve.disapp_sts=0 AND Disapprove_approve.AttendanceDate='" . $range . "' limit 1) as DisapproveReason, (select disapp_remark from Disapprove_approve where Disapprove_approve.EmployeeId=E.Id AND Disapprove_approve.disapp_sts=0 AND Disapprove_approve.AttendanceDate='" . $range . "' limit 1) as DisapproveRemark, E.ImageName,S.shifttype ,S.TimeIn as ctin,E.area_assigned as area,E.Designation as desg,E.Department as dept,E.Gender FROM ShiftMaster S ,AttendanceMaster A,EmployeeMaster E where A.AttendanceDate = '" . $range . "'  $s and A.AttendanceStatus in (2,7) AND E.Id=A.EmployeeId AND S.Id=A.ShiftId  AND E.Is_Delete = 0 And E.archive = 1 AND A.OrganizationId = " . $org_id);
            ...
            foreach ($query->result() as $row)
            {
                ...
                // $query1=$this->db->query("SELECT disapprovereason, disapproveremark FROM `AttendanceMaster` WHERE EmployeeId=? And OrganizationId=? And AttendanceDate=?",array($empid,$org_id,$attdate));
                //                       $data['disreason']="Not Reported";
                //     $data['disremark']="";
                //     if($row1=$query1->row())
                //     {
                //     $disapprovereason=$row1->disapprovereason;
                //     $disapproveremark=$row1->disapproveremark;
                //      if($disapprovereason != '0')
                //      {
                //        $data['disreason']=$disapprovereason;
                //      }
                //         if($disapproveremark != '0')
                //         {
                //                        $data['disremark']=$disapproveremark;
                //         }
                //     }
                // echo $row->DisapproveStatus;
                $name = ucwords(getEmpName($row->EmployeeId));
                if ($name != "")
                {
                    $data['name'] = $name;
    ...
    public function getregister($Data = Null)
    {
        ...
        $query = $this
            ->db
            ->query("SELECT E.Id as empid,E.EmployeeCode as code, E.area_assigned as location,S.shifttype, if(E.LastName!='NULL',concat(E.FirstName, ' ' ,E.LastName),E.FirstName) as name,E.Id,E.Designation as desg,E.PersonalNo, (select COUNT(A.AttendanceStatus) FROM AttendanceMaster A where A.AttendanceStatus IN(1,4,8) AND   A.EmployeeId=E.Id $q) as present, (SELECT COUNT(A.AttendanceStatus) FROM AttendanceMaster A where A.AttendanceStatus in (2,5,7) AND A.EmployeeId=E.Id  $q) as absent , (SELECT COUNT(A.Id) FROM AttendanceMaster A, ShiftMaster S where  A.TimeIn > (CASE WHEN(S.TimeInGrace!='00:00:00') THEN S.TimeInGrace ELSE S.TimeIn END) and A.AttendanceStatus = 1 AND A.EmployeeId=E.Id AND S.Id=A.`ShiftId` $q  ) as latecoming from  EmployeeMaster E, ShiftMaster S,AttendanceMaster A where A.EmployeeId =  E.Id and S.Id=A.`ShiftId` And E.Is_Delete=0 $q  AND A.OrganizationId = $orgid AND E.OrganizationId = $orgid GROUP BY A.EmployeeId ORDER BY $columnName $columnSortOrder,E.FirstName ASC  Limit $start,$rowperpage");
