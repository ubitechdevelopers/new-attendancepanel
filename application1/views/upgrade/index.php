...
<div class="container-fluid">
    <div class ="row"style="position:fixed;width:100vw;">
		...
		<div class = "col-lg-3" style="text-align: -webkit-center;padding-left: 80px;"> 
		<button class="btn btn-md btn-success" type="button">Go To Dashboard</button>
        <i class="fa fa-sign-out" title="Logout" style="font-size:20px;color:red;padding-left:5px;"></i>	
		</div>
	</div>
									   ...
									   <div class="col-sm-6 col-sm-offset-1" >
		                                    <!-- <label><b>Current Plan : Free Trial</b></label> -->
		                                        ...
		                                        <div class="form-group" >
		                                        	...
		                                        	<h2><label class="control-label"> Upgrade</label></h2>
										  ...
										  <input type="radio" id="durationupg" ng-model="userlmt1" value="duration" name="optradio1" ng-click="show()" style="height:18px; width:18px;margin-right:2px;" checked >Duration</label>
										   <label class="radio-inline1"><input type="radio" id="userlimitupg" ng-model="userlmt1"ng-click="hide()"  value="userlimit"  style="height:18px; width:18px;    margin-left: 12px;" name="optradio1" >Users </label>
										   <label class="radio-inline1"><input type="radio" id="Bothupg" ng-model="userlmt1" value="bothud" ng-click="showhide()" style="height:18px; width:18px;    margin-left: 10px;" name="optradio1" >Both Duration & Users </label>
													
		                                        </div>
		                                        
										<div class="form-group" id="duration1" >
											<p><label class="control-label"> Duration</label></p>
										  <label class="radio-inline">
										  <input type="radio" id="yearly" value="Year" ng-model="month"  name="optradio" style="height:18px; width:18px;" ng-click="fetchdiscount()" >Yearly</label>
										   <label class="radio-inline"><input type="radio" id="monthly" ng-model="month"  value="Month" style="height:18px; width:18px;" name="optradio" ng-click="fetchdiscount()" >Monthly </label>
										 </div>
