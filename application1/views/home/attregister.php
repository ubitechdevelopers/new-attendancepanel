                        ...
                        <div class="col-lg-11">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"><span  class="active5"><a href="<?= URL; ?>Attendance/attregister" class="subhead">Attendance Register</a></span></div>
                            ...
                            <div class="form-group" >
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk8" >&nbsp;Designation </label><br>
 ...
 $('#getAtt').click(function(){
      ...
      "scrollX": true,                  
       "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
          ...
          "contentType": "application/json",
                 "ajax": "<?=  URL;?>Attendance/getregister?date="+range+"&empl="+empl+"&desg="+desg+"&area="+area,
                 "columns": [
				{ "data": "code" },
                { "data": "name" },
                { "data": "contect" },
