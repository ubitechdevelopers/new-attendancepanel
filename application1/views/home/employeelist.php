...
<html lang="en">
   ...
   <?php 
      ...
      <style type="text/css">
         ...
         .buttons-collection{  left:44rem!important;}
         }
   ...
   <body>
         ...
         <div id="heading2" class="sticky" style="z-index: 500;padding-bottom: 30px;">
            ...
            <div class="row">
               <div class="col-lg-5 col-md-5 col-sm-7">
                  <nav class="main-nav">
                     <ul>
                        <li class="active5"><a href="<?= URL; ?>Userprofiles/employeelist" class="subhead">Active </a></li>
               ...
               <div id="button-container" class="col-lg-7 col-md-7 col-xs-12" style=" padding: 5px 0px 5px 0px;">
                  <button class="tertiary-button" data-toggle="modal" data-target="#printemp">
                     <div> <span class="side-item-icon" > <img src="<?= URL ?>../assets/icons/download.svg" alt=""> </span> Import Employee </div>
                  </button>
                  <button class="primary-button" >
                     <div> <a href="<?= URL ?>/Userprofiles/addemployee" class="adbtn"><span class="side-item-icon" ><img src="<?= URL ?>../assets/icons/plus.svg" alt="" class="adbtn" style="width: 1rem;"> </span><span style="color: #3366A2;"> Add Employee </span></a></div>
                  </button>
               </div>
            </div>
            ...
            <div class="row ">
               <div class="col-lg-12 col-md-12 col-sm-12" id="next-container" style="display:none;">
                  <button class="btn btn1" data-toggle="modal" data-target="#departments" onclick="updateDepartment();">Department</button>
                  <button class="btn btn1"data-toggle="modal" data-target="#shifts" onclick="updateshift();">Shift</button>
                  <button class="btn btn1"data-toggle="modal" data-target="#designations" onclick="updateDesignation();">Designation</button>
                  <button class="btn btn1"data-toggle="modal" data-target="#qrcodes" onclick="QRcode();">QR Code</button>
                  <button class="btn btn1"data-toggle="modal" data-target="#tracklivelocation">Track Location</button>
                  <button class="btn btn1"data-toggle="modal" data-target="#inactives" onclick="allinactive();">Inactive</button>
                  <button class="btn btn1"data-toggle="modal" data-target="#geolocation" onclick="updateGeolocation();">Geo Center</button>
               </div>
            </div>
         </div>
         </div>
         ...
         <table id="example" class="table" style="width:100%;">
            <thead>
               <tr style="">
                  ...
                  <th style="padding: 0px;">Employee Code</th>
                  <th>Profile</th>
                  <th >Name</th>
                  <th>Department</th>
                  <th>Designation</th>
                  <th>Shift</th>
                  <th>Phone</th>
                  <th  style="padding-left: 0.5rem;padding-right: 0.5rem">Permissions</th>
                  ...
                  <th >Geo Center</th>
                  <!--<th>Password</th>-->
                  <th  style="padding-left: 0.5rem;padding-right: 0.5rem">Action</th>
               </tr>
            </thead>
         </table>
         <br>
                     ...
                     <div class="form-group" >
                        <div class="row">
                           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                              ...
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk1"disabled>&nbsp;Employee Code</label>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk2"disabled>&nbsp;Profile</label>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3"disabled>&nbsp;Name</label> 
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4"disabled>&nbsp;Department</label>
                           </div>
                           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk5"disabled>&nbsp;Designation</label>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6"disabled>&nbsp;Shift</label>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk7" disabled>&nbsp;Phone</label>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk8"disabled>&nbsp;Permissions</label>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk9" >&nbsp;Username / Email </label>
                           </div>
                           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk10" >&nbsp;Shift Type</label>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk11" >&nbsp;Country</label>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk12" >&nbsp;Timezone</label>  
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk13" >&nbsp;Hourly Rate</label> 
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk14" >&nbsp;Status</label>
                           </div>
                           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk15" >&nbsp;Track Location</label>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk16" >&nbsp;Geo Center</label>
                           </div>
                           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                           </div>
                        </div>
      ...
      <!--  Assign shift-->
      <div class="modal fade" id="shifts" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Assign Shift</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
      ...
      <!--  Assign Department-->
      <div class="modal fade" id="departments" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Assign Department</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
      ...
      <!--  Assign Designation-->
      <div class="modal fade" id="designations" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Assign Designation</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
      ...
      <!-- Track Location-->
      <div class="modal fade" id="tracklivelocation" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Track Location</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
      ...
      <!--  Assign geolocation -->
      <div class="modal fade" id="geolocation" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Assign Geo Location</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               <div class="modal-body">
                     ...
                     <div class="row">
                        <div class="col-md-7">
                           <div class="form-group label-floating">
                              ...
                              <select id="geolocationS" class="form-control selectpicker" style="width:100%;" multiple data-hide-disabled="true" data-live-search="true" data-actions-box="true">
                              <?php
                  ...
                  <div class="right mt-4">
                     <button type="button"  id="resetgeolocation" class="btn btn-light bttn" data-dismiss="modal" style="color: grey;">Close</button>
                     &nbsp;&nbsp;
      ...
      <!-- Inactive Employee-->
      <div class="modal fade" id="inactives" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Inactive Employee</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               <div class="modal-body">
                  ...
                  <!--  <div class="row">
                     <div class="col-lg-4">
                       ...
                       <div class="col-lg-8">-->
                  <div class="right">
                     <button type="button"  class="btn btn-light bttn" data-dismiss="modal" style="color: grey;">Close</button>
                     &nbsp;&nbsp;
      ...
      <!--////edit///-->
      <div class="modal fade" id="addEmpE" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                  ...
                  <h5 class="modal-title" id="title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp; Update Employee</a></h5>
                  <div>
                     <button type="button" id="" class="btn btn-light" data-dismiss="modal"style="width:9rem;">Close</button>
      ...
      <div class="modal fade" id="changestatus" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title" id="title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp; Change Status</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
      ...
      <div class="modal fade" id="delEmp" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp; Archive Employee</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
      ...
      <!--qrcode-->
      <div id="genQR"  class="modal fade " data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog modal-sm"  >
            <!-- Modal content-->
            <div class="modal-content print" >
               <div class="modal-header  " >
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"  class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp; Employee Identity Card</a></h5>
                 <h5><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist" data-dismiss="modal" >x</h5>
               ...
               <div class="modal-body" >
                  <div style="font-family: poppins;">
                     ...
                     <center class="mt-3">
                        ...
                        <button class="btn btn-warning nonPrintable mt-4 mb-4" onclick="printDiv('genQR')" value="print a div!" style="width:12rem;">Print</button>
                     </center>
                  </div>
               </div>
            </div>
      ...
      <!--////reset password///-->
      <div class="modal fade" id="resetpwd" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp; Reset Password</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               ...
               <div class="modal-footer">
                  <button type="button " data-dismiss="modal"  class="btn btn-light" style="width:9rem;">Cancel</button>
                  <button type="button"  id="submitResetPassword" class="btn btn-success" style="width:9rem;">Submit</button>
               </div>
            </div>
         </div>
      </div>
      <div class="modal fade" id="printemp" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;&nbsp;&nbsp;Import Employee</a></h5>
                  ...
                  <form id="upload_csv" method="post" enctype="multipart/form-data">
                     ...
                     <div class="row">
                        ...
                        <div class="col-4 mt-3 ml-3">
                           <button type="button" class="btn" style="width:12rem; font-weight: 700px;  color:rgba(122, 122, 122, 1);   border-color: #E5E5E5;"><a href="<?php echo IMGURL5; ?>../assets/newjoiningfile.CSV" style="color:rgba(122, 122, 122, 1); ">Download Sample</a></button>
                        </div>
                        <div class="col-4"></div>
                     </div>
                     <div class="row">
                        ...
                        <div class="col-4 mt-3 ml-5 mb-3">
                           <button type="submit" id="btn1" class="btn btn-success btnfile call" style="width:8rem;" data-toggle="modal" data-target="#register-form" disabled>Import</button>
                        </div>
                        <div class="col-4"></div>
                     </div>
                  </form>
      ...
      <div class="modal fade" id="register-form" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="<?php echo URL; ?>Userprofiles/employeelist"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;&nbsp;&nbsp;Import Employee</a></h5>
               ...
               <div class="modal-footer" style="height:10rem;">
                  ...
                  <button type="button" class="btn btn-light" data-dismiss="modal" style="width:8rem; color: black!important;" id="impcancel"><a href="<?= URL; ?>Userprofiles/employeelist">Cancel</a></button>
         ...
         $(document).ready(function () {
             $("#registers").click(function (event) {
                 ...
                 if ($('#ecode').val() != undefined)
                     ecode = $('#ecode').val();
                 $.ajax({url: "<?php echo URL; ?>userprofiles/emportEmp",
                     method: "POST",
                     data: {"fname": fname, "dept": dept, "desg": desg, "shift": shift, "email": email, "password": password, "cont": cont, "ecode": ecode, "country": country, "doj": doj},
                     success: function (result) {
                         //alert(result);
      ...
      <script>
         ...
         $("#submitResetPassword").click(function () {
             ...
             //return false;
             //}
             $.ajax({url: "<?php echo URL; ?>userprofiles/resetPassword",
...
if(!$("input[name='track']:checked").val() )
      ...
      <script>
         ...
         //       // $("#addEmpE").modal('show');
             ...
             $.ajax({url: "<?php echo URL; ?>userprofiles/editemployee",
                 type: "post",
                 datatype: "html",
                 data: {"eid": eid},
                 success: function (result)
