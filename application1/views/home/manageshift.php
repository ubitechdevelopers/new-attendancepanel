...
.row {
	...
	margin-left:-8px;
      ...
      <!--  <?php
         ...
         if($orgid=="35171" || $orgid=="70799 " || $orgid=='10'){?> -->
      <!--  <script>
   ...
   <body ng-app ="adminapp"  ng-controller="attroasterCtrl">
      ...
      <div class="modal fade" id="viewshift" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="http://ubiattendance.zentylpro.com/ubiattnew2/index.php/Managesettings"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Shift List</a></h5>
      ...
      <div class="modal fade" id="assign" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="#" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Assign Shift</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <div class="container">
                        ...
                        <!-- ##############################Grace Time ###################### -->
                        <?php if($orgid=="35171" || $orgid=="70799" || $orgid=='10'){?>
                        <div class="form-group row" style="margin-top: -2rem;" id="gracerow">
                           <div class="col-sm-3">
                           </div>
         ...
         // alert(total);
          ...
          if(selectcheck!=0){
             ...
             //alert("json"+json);
              ...
              $http({
                  url: '<?= URL;?>Managesettings/SaveEmpdeptList',
                  method: "POST",
                  data: xsrf,
                  headers: {'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'}
              }).success(function(data, status, headers, config){
