    ...
    <head>
        ...
        <style type="text/css">
         ...
         position: absolute;
            ...
            table.dataTable tbody td:nth-child(20) {
                padding-top: 1.8rem!important;
            } 
        ...
        <main class="main" style="width: 83.3%;">
              ...
              <div id="heading2" class="sticky" style="z-index: 500; padding-bottom: 30px;">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="primary-text">Attendance</div>
                        
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding: 0px;padding-left: 29rem;">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk0" disabled>&nbsp;Name</label><br>
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk1" disabled >&nbsp;Shift</label>
                                        <br>

                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk2" disabled>&nbsp;date</label><br>
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled>&nbsp;Time In Date</label><br>
                                         
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" disabled>&nbsp;Time In </label><br> 
                                       
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                       
                                       
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk5" disabled >&nbsp;Time out Date</label><br>
                                          <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6" disabled>&nbsp;Time Out</label><br>
                                          <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk7" disabled>&nbsp; Logged Hours</label>
                                        <br>
                                            <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk8" disabled>&nbsp;Status</label><br>
                                          <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk9" >&nbsp;Shift type</label><br>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk10" >&nbsp;Profile Image</label><br>
                                         <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk11" >&nbsp;Time In City</label>
                                        <br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk12" >&nbsp;Time In App version</label><br>
                                         
                                          <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk13" >&nbsp;Time Out city </label>
                                        <br>
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk14" >&nbsp;Time Out App version  </label>
                                        <br>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                        ...
                                        <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk15" >&nbsp;Device</label>
                                        <br>
                                       
                                       <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk16" >&nbsp;Employee code</label><br>
                                    </div>
                                </div>
                            </div>
                            <div class="right">
