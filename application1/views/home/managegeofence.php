      ...
      <main class="main">
            ...
            <div id="heading2" class="sticky" style="z-index: 500; padding-bottom: 30px;">
               ...
               <div class="row">
				   ...
				   <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" style="padding-left: 4.9rem;">
				    <button class="primary-button addemp"title="Geo fence restriction" data-toggle="modal" data-target="#addEmp">
            ...
            <div class="modal-dialog">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title"><a class="a" href="http://ubiattendance.zentylpro.com/ubiattnew2/index.php/Managesettings"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Geo Fence Restriction</a></h5>
