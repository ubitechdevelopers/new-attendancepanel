...
<body>
    ...
    <main class="main" style="width: 83.7%;">
        ...
        <div id="heading2" class="sticky" style="z-index: 500; padding-bottom: 5px;">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-5 col-sm-12 col-xs-12" style="padding: 0px;padding-left: 15.5rem;">
                    <div class="row">
                     ...
                     &nbsp;&nbsp;&nbsp;&nbsp; -->
                        <button class="tertiary-button" data-target="#printemp" data-toggle="modal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="email" value="" placeholder="Enter Email ">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <button type="button" class="btn btn-light bttn fit" data-dismiss="modal">Cancel</button>
                            &nbsp;&nbsp;
                            <button type="button" id="savestatus" class="btn btn-success bttn fit">Save</button>
                        </div>
                    </div>
                </div>
                <!--  <div class="modal-footer">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><a class="a" href="#"><i class="fa fa-chevron-left"
                                style="font-size: 1rem;"></i>&nbsp;&nbsp;&nbsp;Import Employee</a></h5>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="height:10rem;">
                    <div class="showresult" style="display:none; padding-left:-40px;">
                        <p>Total records : <span id="repeatemp"></span></p>
                        <p>Total inserted records : <span id="importemp"></span></p>
                        <a href="<?php echo URL; ?>clientsettings/showTMP" class="btn btn-link">show insuffiecient
                            record</a>
                    </div>
    ...
    <form id="myFormid" method="post" action="<?php echo URL; ?>clientsettings/QRcode" target="_blank">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group label">
                                    ...
                                    <input type="text" class="form-control alpha" id="addrE">
                            ...
                            <div class="col-md-6">
                                <div class="form-group label">
                                    ...
                                    <input type="text" class="form-control alpha" id="cityE">
