    ...
    <div class="container1">
		...
		<input type="hidden"  id="id" value='<?php echo $row[0]['change']; ?>' />
            ...
            <div class="row mb-4 mt-3 ">
                ...
                <div class="col-4">
                    <span class="step3"onclick="fieldset3()" ><a href="#"class="stepform" style="padding: 14px 10px 12px 10px;"><b class="ml-4">Geo Fence</b></a></span>
                </div>
            </div>
            ...
            <div class="fieldset3">
                <div class="row">
                    ...
                    <div class=" col-md-1 col-lg-1 mt-2"> <label class="switch">
