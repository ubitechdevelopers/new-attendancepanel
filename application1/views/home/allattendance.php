   ...
   <body>
               ...
               <div class="col-lg-11">
                  <div class="swiper-container">
                     <div class="swiper-wrapper">
                        <div class="swiper-slide"><span class="active5"> <a href="<?= URL; ?>Attendance/allattendance" class="subhead">All Attendance</a></span></div>
                        ...
                        <div class="swiper-slide"><span><a href="<?= URL; ?>Attendance/deptsummary" class="subhead">Department Summary</a></span></div>
                     ...
                     <div class="form-group" >
                        <div class="row">
                           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                              ...
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk1" disabled >&nbsp;Time In</label>
                              <br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk2" disabled>&nbsp;Time In Image</label><br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk3" disabled>&nbsp;Time Out</label><br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk4" disabled>&nbsp;Time Out Image </label><br> 
                           </div>
                           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk5" disabled >&nbsp;Logged Hours</label><br>
                              
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk6"disabled>&nbsp;Status</label><br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk7">&nbsp;Date</label><br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk8">&nbsp;Time In Date</label>
                              <br>
                               <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk9">&nbsp;Time Out Date</label><br>
                              
                           </div>
                           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk10" >&nbsp;Shift type</label><br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk11" >&nbsp;Profile Image</label><br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk12" >&nbsp;Time In City</label>
                              <br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk13" >&nbsp;Time In App version</label><br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk14" >&nbsp;Time Out city </label>
                              <br>
                              
                           </div>
                           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk15" >&nbsp;Time Out App version  </label>
                              <br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk16" >&nbsp;Device</label>
                              <br>
                              <label class="filtr"><input type="checkbox" class="modal_checkbox" id="chk17" >&nbsp;Employee code</label><br>
                           </div>
                        </div>
                     </div>
                     <div class="right">
      ...
      <div id="addAttc" class="modal fade" role="dialog">
         <div class="modal-dialog">
            ...
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="#" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Update Attendance</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
                  ...
                  <form id="AttForm">
                     ...
                     <div class="row ">
                        <div class="col-md-10">
                           ...
                           <label for="colFormLabelSm" class="col-sm-6 col-form-label col-form-label-sm">Time In<span class="red">*</span></label>
               ...
               <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-default " data-dismiss="modal" style="margin-top: 10px;">Cancle</button>
               </div>
            </div>
         </div>
      </div>
                     ...
                     <div class="row addAttENewcoHide">
                        ...
                        <div class="col-md-6">
                           <div class="form-group label-floating">
                              ...
                              <div class="input-group mb-3 clockpicker form-group" data-placement="bottom" data-align="top" data-autoclose="true">
                                 <div class="input-group mb-3">
                                    <input type="text" class="form-control"  name="timeInEnew"  id="timeInEnew" readonly>
                                    <div class="input-group-append">
                                       <span class="input-group-text" id="basic-addon2" style="padding :5px;"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                                    </div>
                                 </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group label-floating">
                              <label for="colFormLabelSm" class="col-sm-6 col-form-label col-form-label-sm">Time Out<span class="red">*</span></label>
                              <div class="input-group mb-3 clockpicker form-group" data-placement="bottom" data-align="top" data-autoclose="true">
                                 <div class="input-group mb-3">
                                    <input type="text" class="form-control"  name="timeOutEnew"  id="timeOutEnew" readonly>
                                    <div class="input-group-append">
                                       <span class="input-group-text" id="basic-addon2" style="padding :5px;"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                                    </div>
                                 </div>
                     ...
                     <div class="row addAttENewcoHide " id="shifttypedate">
                        <div class="col-md-6">
                           <div class="form-group ">
                              ...
                              <input type="text"  id="attInDateEnew"   class="form-control datepicker" readonly="readonly" disabled>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group ">
                              <label class="control-label">Time Out Date<span class="red">*</span></label>
                              <input type="text"  id="attOutDateEnew"   class="form-control datepicker" readonly="readonly">
                           </div>
                        </div>
                     </div>
                     <div class="clearfix"></div>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <button type="button" id="saveskStatus"  class="addAttskStatusUp btn btn-success bttn fit" >Update</button>
               </div>
            </div>
         </div>
      </div>
      ...
      <!--Edit attendance modal start-->
      <div class="modal fade" id="addAttsts" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="#" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Update Attendance</a></h5>
      ...
      <div class="modal fade" id="disAtt" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="#" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Disapprove Attendance</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               ...
               <div class="modal-footer">
                  <button type="button" id="disapproveid1"  class="btn btn-light bttn fit" data-dismiss="modal">Cancel</button>
      ...
      <div class="modal fade" id="delAtt" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="#" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Delete Attendance</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               <div class="modal-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-9" style="text-align: end;">
                        <button type="button" id="delete1"  class="btn btn-light bttn fit" data-dismiss="modal">Cancle</button>
      ...
      <div class="modal fade" id="delAttnew" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title"><a class="a" href="#" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Delete</a></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
      ...
      <div class="modal fade" id="locationmodal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                     <h5 class="modal-title"><a href="#"class="close a" data-dismiss="modal" aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Add Geo Center</a></h5>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                     </button>
                  </div>
   ...
   <script>
      ...
      $('#filtermodal').modal('show');
          ...
          api.column(7, {page:'current'} ).data().each( function ( group, i ) {
            if ( last !== group ) {
              $(rows).eq( i ).before(
                '<tr class="group"><td bgcolor="white" colspan=16><span class="dat">'+group+'</span><span> &nbsp; &nbsp;  </span></td></tr>'
              );
              last = group;
            }
          } );
      ...
      $('#filtermodal').modal('show');
       ...
       "scrollX": true,                  
        "dom": '<"pull-left"l>B<"pull-left"f>rtip',   
         ...
         "contentType": "application/json",
                  "ajax": "<?= URL; ?>Attendance/getAbsent__new?date=" + range + "&shift=" + shift + "&dept=" + dept + "&empl=" + empl + "&desg=" + desg + "&attendance=" + attendance,
                  "columns": [
                  {"data": "name"},
                  // {"data": "shift"},
      ...
      "contentType": "application/json",
                  "ajax": "<?= URL; ?>Attendance/getAttendances__new?date=" + range + "&shift=" + shift + "&dept=" + dept + "&empl=" + empl + "&desg=" + desg + "&attendance=" + attendance,
                  "columns": [
                 {"data": "name"},
                  // {"data": "shift"},
      ...
      $('#filtermodal').modal('show');
               ...
               language: {
                  ...
                  "contentType": "application/json",
                  "ajax": "<?= URL; ?>Attendance/getAttendances__both?date=" + range + "&shift=" + shift + "&dept=" + dept + "&empl=" + empl + "&desg=" + desg + "&attendance=" + attendance,
                  "columns": [
                  {"data": "name"},
                  // {"data": "shift"},
...
//alert($('#empid').attr("data-id"));
      ...
      $('#saveEE').click(function () {
          ...
          $.ajax({url: "<?php echo URL; ?>attendance/editAttUBI",
   ...
   <script>
      $(document).ready(function () {
          $('.toggle-sidebar').click(function () {
              ...
              $("#sidebar").load('<?= URL ?>attendance/helpNav', {'pageid': 'allattendance'});
          });
   ...
   <script>
      $(document).on('click', "#saveskStatus", function () {
         ...
         // alert(status);
          ...
          $.ajax({url: "<?php echo URL; ?>attendance/updatestatus",
      ...
      $(document).on('click', "#saveEStatus", function () {
          ...
          //$.ajax({url:"<?php echo URL; ?>admin/updatestatus",
          $.ajax({url: "<?php echo URL; ?>attendance/updatestatusnew",
   ...
   $(document).on('click','.test',function(){
    ...
    /* var latti=26.2042033;
     var longi=78.2062945;*/
     var t = $('#latitid').val();
		console.log('shakir');
		console.log(t);
 ...
 function initMap() {
  const myLatLng = { lat: 26.2042033, lng: 78.2062945 };
