...
return $data;
    ...
    function getClientlist($postData = Null)
    {
        ...
        foreach ($query->result() as $row) {
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 5.8rem; height:3.9rem; margin-top:50%;  border-radius:5px;   margin-left:-25%"">

            <li class="hover" style="height:30px; padding-top:6%; margin-top:-9%; font-size:13px;" data-toggle="modal"> 
             <a href="#" style="font-size:13px; margin-left:10px; color:black; font-weight:500;font-family:poppins!important;"><i class="fa fa-eye  " id="showclientlist"   style="font-size:13px;   color:black; font-weight:500; " data-toggle="modal" title="View"
              ...
              data-target="#editclient">&nbsp&nbspView</a></i></li>
                ...
                <li  class="hover" style="height:30px; padding-top:6%; font-size:13px;" data-toggle="modal">  
