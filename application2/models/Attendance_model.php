    ...
    public function getAttendances__both()
    {
        ...
        foreach ($query->result() as $row)
        {
            ...
            if ($name != "")
            {
                ...
                if ($row->areaId != 0 && ($row->latit_in != 0.0 && $row->longi_in != 0.0 && $row->latit_out != 0.0 && $row->longi_out != 0.0) || ($row->TimeInGeoFence == '' || $row->TimeOutGeoFence == ''))
                {
                    ...
                    if (count($arr1) > 1)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                $data['positionlin'] = '<span class="test" data-toggle="modal" data-target="#locationmodal" data-attid="' . $row->Id . '" data-id="' . $row->EmployeeId . '" data-latit="'.$row->latit_out.','.$row->longi_out.'" data-latitin="'.$row->latit_out.'" data-longiin="'.$row->longi_out.'" ><img src="' . URL . "../assets/icons/without.svg" . '"  style="width:28.33px!important;height:28.33px!important;" title="' . $row->CheckOutLoc . '"/></span>';
                        ...
                        else
                        {
                            if ($d2 <= $radius)
                            {
                                $data['positionout'] = '<span  class="test1"  data-attid="' . $row->Id . '" data-id="' . $row->EmployeeId . '"  data-latit="' . $row->latit_in . ',' . $row->longi_in . '" data-latitin="' . $row->latit_in . '" data-longiin="' . $row->longi_in . '" ><img src="' . URL . "../assets/icons/withgeo.svg" . '"  style="width:28.33px!important;height:28.33px!important;"title="' . $row->checkInLoc . '"/></span>';
                            }
                            else
                            {
                                $data['positionout'] = '<span class="test1"  data-attid="' . $row->Id . '" data-id="' . $row->EmployeeId . '" data-latit="'.$row->latit_out.','.$row->longi_out.'" data-latitin="'.$row->latit_out.'" data-longiin="'.$row->longi_out.'" ><img src="' . URL . "../assets/icons/without.svg" . '"  style="width:28.33px!important;height:28.33px!important;"  title="' . $row->CheckOutLoc . '"/></span>';
                    ...
                    if (count($arr1) > 1)
                    {
                        ...
                        elseif (($row->latit_in == 0.0 && $row->longi_in == 0.0) && ($row->latit_out != 0.0 && $row->longi_out != 0.0))
                        {
                            ...
                            else
                            {
                                if ($d2 <= $radius)
                                {
                                    $data['positionout'] = '<span  class="test1"  data-attid="' . $row->Id . '" data-id="' . $row->EmployeeId . '"  data-latit="' . $row->latit_in . ',' . $row->longi_in . '" data-latitin="' . $row->latit_in . '" data-longiin="' . $row->longi_in . '" ><img src="' . URL . "../assets/icons/withgeo.svg" . '"  style="width:28.33px!important;height:28.33px!important;"title="' . $row->CheckOutLoc . '"/></span>';
                                }
                                else
                                {
                                    $data['positionout'] = '<span class="test1"  data-attid="' . $row->Id . '" data-id="' . $row->EmployeeId . '" data-latit="'.$row->latit_out.','.$row->longi_out.'" data-latitin="'.$row->latit_out.'" data-longiin="'.$row->longi_out.'" ><img src="' . URL . "../assets/icons/without.svg" . '"  style="width:28.33px!important;height:28.33px!important;"  title="' . $row->CheckOutLoc . '"/></span>';
               ...
               // $data['test1'] = '<i class="fa fa-map-marker fa-2x" style="margin-left:0.5rem;color:#FF0000;" data-target="#locationmodal"  data-toggle="modal"  title="' . $row->CheckOutLoc . '" data-toggle="tooltip" data-placement="top"></i></button>';
                  $data['test1'] = '<span class="test1"  data-attid="' . $row->Id . '" data-id="' . $row->EmployeeId . '" data-latit="'.$row->latit_out.','.$row->longi_out.'" data-latitin="'.$row->latit_out.'" data-longiin="'.$row->longi_out.'" ><img src="' . URL . "../assets/icons/without.svg" . '"  style="width:28.33px!important;height:28.33px!important;"  title="' . $row->CheckOutLoc . '"/></span>';
                ...
                if (date('Y-m-d') == $row->AttendanceDate && $permis == 1 && $permis1 == 1 && $row->shifttype == 3 or ($row->shifttype == 1 && $row->MultipletimeStatus == 1))
                {
                    ...
                    if ($row->TimeOut == '00:00:00' && $row->timeoutdate == '0000-00-00')
                    {
                        ...
                        <!-- three dots -->
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 10rem; height:6.5rem; border-radius:5px; margin-left:-120% margin-top:-8%;">
          ...
          <li class="q3 hover" style="height:30px;" ><i class="fa fa-clock-o" style="font-size:16px; margin:0px 8px 0px 6px;"  title="View"></i> <a href="' . URL . 'attendance/viewflexiattendance/' . $row->EmployeeId . '/' . $row->Id . '" style="color:black; font-size:13px; margin-left:5px;">View</a></li>
                        ...
                        <!-- three dots -->
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9rem; height:6rem; border-radius:4px; margin-left:-120% margin-top:-8%;">

                            <li class="track_loc hover" style="height:30px;"><i class="track_loc fas fa-walking" style="font-size:16px; margin:0px 8px 0px 6px;"    title="No Punched visits"></i> <a href="trackLocations/' . $row->EmployeeId . '/' . $row->AttendanceDate . '/' . substr($row->TimeIn, 0, 5) . '/' . substr($row->TimeOut, 0, 5) . '/' . $data['wh'] . '" target="_self" style="color:black; font-size:13px; margin-left:5px;">No Punched visits</a></li>
 ...
 <li class="q4 hover" style="height:30px;"><i class="fa fa-clock-o" style="font-size:16px; margin:0px 8px 0px 6px;"    title="view"></i> <a href="' . URL . 'attendance/viewflexiattendance/' . $row->EmployeeId . '/' . $row->Id . '" target="_self" style="color:black; font-size:13px; margin-left:5px;">view</a></li>
          ...
          <li class="q5 hover" style="height:30px;" ><i class="fa fa-clock-o" style="font-size:16px; margin:0px 8px 0px 6px;"  title="View"></i> <a href="' . URL . 'attendance/viewflexiattendance/' . $row->EmployeeId . '/' . $row->Id . '" style="color:black; font-size:13px; margin-left:5px;">View</a></li>
                        ...
                        <!-- three dots -->
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9rem; height:5rem; border-radius:5px;margin-left:-120% margin-top:-8%;">

                            <li class="track_loc hover" style="height:30px;"><i class="fas fa-walking" style="font-size:16px; margin:0px 8px 0px 6px;"    title="No Punched visits"></i> <a href="#" target="_self" style="color:black; font-size:13px; margin-left:5px;">No Punched visits</a></li>
          ...
          <li class="q7 hover" style="height:30px;" ><i class="fa fa-clock-o" style="font-size:16px; margin:0px 8px 0px 6px;"  title="View"></i> <a href="' . URL . 'attendance/viewflexiattendance/' . $row->EmployeeId . '/' . $row->Id . '" style="color:black; font-size:13px; margin-left:5px;">View</a></li>
                        ...
                        <!-- three dots -->
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9rem; height:4rem; border-radius:5px; margin-left:-120% margin-top:-8%;">
          ...
          <li class="q8 hover" style="height:30px;" ><i class="fa fa-clock-o" style="font-size:16px; margin:0px 8px 0px 6px;"  title="View"></i> <a href="' . URL . 'attendance/viewflexiattendance/' . $row->EmployeeId . '/' . $row->Id . '" style="color:black; font-size:13px; margin-left:5px;">View</a></li>
                    ...
                    else
                    {
                        ...
                        <!-- three dots -->
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 10rem; height:6rem; border-radius:5px; margin-left:-120% margin-top:-8%;">
                ...
                elseif ($row->AttendanceDate < date('Y-m-d') && date('Y-m-d') != $row->AttendanceDate && $permis == 0 && $permis1 == 1 && $row->AttendanceStatus != 2 && $row->shifttype == 3 || ($row->shifttype == 1 && $row->MultipletimeStatus == 1))
                {
                    ...
                    if (($eid == $empid) && ($attdate == $checkindate))
                    {
                        ...
                        <!-- three dots -->
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 10rem; height:4rem; border-radius:5px; margin-left:-120% margin-top:-8%;">
          ...
          <li class="q1 hover" style="height:30px;" ><i class="fa fa-clock-o" style="font-size:16px; margin:0px 8px 0px 6px;"  title="View"></i> <a href="' . URL . 'attendance/viewflexiattendance/' . $row->EmployeeId . '/' . $row->Id . '" style="color:black; font-size:13px; margin-left:5px;">View</a></li>
                    ...
                    else
                    {
                        ...
                        <!-- three dots -->
                            ...
                            <li class="track_loc hover" style="height:30px;"><i class="fas fa-walking" style="font-size:16px; margin:0px 8px 0px 6px;"    title=" No Punched visits"></i> <a href="javascript:;" target="_self" style="color:black; font-size:13px; margin-left:5px;"> No Punched visits</a></li>
                    ...
                    else
                    {
                        if ($row->AttendanceStatus == 2 && $row->TimeIn == '00:00:00' && $row->timeindate == '0000-00-00' && $row->AttendanceDate > date('Y-m-d', strtotime('-2 day', strtotime(date('Y-m-d')))) && date('Y-m-d') != $row->AttendanceDate)
                        {
                            ...
                            $data['action'] = '  <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9.5rem; height:2.5rem; border-radius:5px; margin-top:-8%; margin-left:-125%">
...
data-attendancedate="' . $row->AttendanceDate . '";><i class="fa fa-pencil  material-icons" style="font-size:16px; margin:0px 8px 0px 6px;"  title="Edit"></i><a href="#" style="color:black; font-size:13px; margin-left:5px;">Edit</a></li>
                        ...
                        else
                        {
                            ...
                            $data['action'] = '  <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9.5rem; height:2.5rem; border-radius:5px;margin-left:-125% margin-top:-8%;">
                        ...
                        else
                        {
                            ...
                            $data['action'] = '  <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9rem; height:6rem; border-radius:5px;margin-left:-120% margin-top:-8%;">
                                  ...
                                  <li class="track_loc hover" style="height:30px;"><i class="fas fa-walking" style="font-size:16px; margin:0px 8px 0px 6px;"    title="No Punched visits"></i> <a href="#">No Punched visits</a></li>
                        ...
                        else
                        {
                            $data['action'] = '  <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9rem; height:3rem; border-radius:5px;margin-left:-120% margin-top:-8%;">
                                  ...
                                  <li class="track_loc hover" style="height:30px;"><i class="fas fa-walking" style="font-size:16px; margin:0px 8px 0px 6px;"    title="No Punched visits"></i> <a href="t#" target="_self" style="color:black; font-size:13px; margin-left:5px;">No Punched visits</a></li>
                    ...
                    else
                    {
                        $data['action'] = '  <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9rem; height:3rem; border-radius:5px; margin-left:-120% margin-top:-8%;">
                                  ...
                                  <li class="track_loc hover hover" style="height:30px;"><i class="fas fa-walking" style="font-size:16px; margin:0px 8px 0px 6px;"    title="No Punched visits"></i> <a href="t#" target="_self" style="color:black; font-size:13px; margin-left:5px;">No Punched visits</a></li>
                                        </ul>
             </div> ';
                    }
                    ...
                    if ($row->TimeOut == '00:00:00' && $row->timeoutdate == '0000-00-00')
                    {
                        if (($eid == $empid) && ($attdate == $checkindate))
                        {
                            $data['action'] = '  <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 10rem; height:8rem; border-radius:5px; margin-left:-120% margin-top:-8%;">
             ...
             data-timein="' . date("H:i", strtotime($row->TimeIn)) . '"><i class="fa fa-trash" style="font-size:16px; margin:0px 8px 0px 6px;"  data-aid="' . $row->Id . '" data-aname="' . $emp_name . '" data-attdate="' . $row->AttendanceDate . '"  title="Delete"></i> <a href="javascript:;" style="color:black; font-size:13px; margin-left:5px;">Delete</a></li>
                        ...
                        else
                        {
                            $data['action'] = '  <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9rem; height:8rem; border-radius:5px;margin-left:-120% margin-top:-8%;">
                    ...
                    else
                    {
                        ...
                        if (($row->AttendanceStatus == 7 && ($row->Wo_H_Hd == 11 || $row->Wo_H_Hd == 12)) && ($attdate != date("Y-m-d")))
                        {
                            ...
                            $data['action'] = '  <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9rem; height:6rem; border-radius:5px; margin-left:-120% margin-top:-8%;">
                                  <li class="track_loc hover" style="height:30px;"><i class="fas fa-walking" style="font-size:16px; margin:0px 8px 0px 6px;"    title="No Punched visits"></i> <a href="" target="_self" style="color:black; font-size:13px; margin-left:5px;">No Punched visits</a></li></ul></div> ';
                        ...
                        else
                        {
                            $data['action'] = '  <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="min-width: 9rem; height:6rem; border-radius:5px;  margin-top:-8%; margin-left:-120%">
                                  <li class="tests track_loc hover" style="height:30px;"><i class="fas fa-walking" style="font-size:16px; margin:0px 8px 0px 6px;"    title="No Punched visits"></i> <a href="" target="_self" style="color:black; font-size:13px; margin-left:5px;">No Punched visits</a></li>
