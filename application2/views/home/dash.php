...
<a href="#" style="color: black; text-decoration: none;"><h5 style="margin-top: 19%; font-weight: 600;">Leave</h5><h4 style="font-weight: 600;"><?php if(isset($leaves)){echo ($leaves); }else{echo 0;} ?></h4></a>
   </div>
</div>
