...
<br>
         ...
         <div class="modal fade" id="livelocationtracking" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  ...
                  <div class="modal-body">
                     <form>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-6">
                              <input class="form-control fnt" name="livelocationmonth" type="number" id="month123" min="1" max="50" value = "1" onchange="myFunction()" onKeyUp="if(this.value>50){this.value='50';}else if(this.value<0){this.value='0';}"onkeypress="return event.charCode === 0 || /\d/.test(String.fromCharCode(event.charCode));"/>
                           </div>
                        </div>
                        <div class="form-group row">
         ...
         <!--------Live Location Tracking End----------->
          ...
          <!-- Geo Fence -->
         <div class="modal fade" id="geofence" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title"><a class="a" href="#"class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-chevron-left" style="font-size: 1rem;"></i>&nbsp;Geo Fence</a></h5>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                     </button>
                  </div>
                  ...
                  <div class="modal-body">
                     <form>
                        <div class="form-group row">
                           <label for="inputPassword" class="col-sm-6 col-form-label fnt">Number of User</label>
                           <div class="col-sm-6">
                              <input type="text" name="livelocationtracking" class="form-control fnt" id="userlimit1" value= "<?php echo $user;?>" readonly />
                           </div>
                        </div>
                        <div class="form-group row">
                           <label for="inputPassword" class="col-sm-6 col-form-label fnt">Addon Price per month</label>
                        ...
                        <div class="form-group row">
                           <label for="inputPassword" class="col-sm-6 col-form-label fnt">Month(s)</label>
                           <div class="col-sm-6">
                              <input class="form-control fnt" name="geofencemonth" type="number" id="month1231" min="1" max="50" value = "1" onchange="myFunction1()" onKeyUp="if(this.value>50){this.value='50';}else if(this.value<0){this.value='0';}"onkeypress="return event.charCode === 0 || /\d/.test(String.fromCharCode(event.charCode));"/>
                           </div>
                        </div>
                        <div class="form-group row">
                           <label for="inputPassword" class="col-sm-6 col-form-label fnt">Total</label>
...
// alert(oid);
   ...
   var addonname = "live location tracking";
