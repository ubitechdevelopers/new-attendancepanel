...
<body ng-app = "adminapp"  ng-controller="attroasterCtrl" ng-init="fetchtablemonthlydata();fetchtablemonthlydata1();"   >
	<div class="wrapper"  >  <!--- ng-init="fetchtablemonthlydata();-->
	    ...
	    <div class="main-panel">
			...
			<?php if($_SESSION['orgid'] == 70799)
			 {
			 ?>	
			<a download="Monthlyreport.xls" href="#" onclick="return ExcellentExport.excel(this,'example1','Monthly Report');" class="dt-button buttons-excel buttons-html5" style="margin-bottom:-25px;">Excel</a>
             <?php }else {?>
