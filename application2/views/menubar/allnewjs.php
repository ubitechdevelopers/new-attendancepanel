 ...
 <script src="<?= URL ?>../assets/js/jquery.min.js"></script>
  <script src="<?= URL ?>../assets/js/jquery1.11.0min.js"></script>
<script src="<?= URL ?>../assets/js/bootstrap-notify.js"></script>
      ...
      <script src="<?= URL ?>../assets/js/custom.js" type="text/javascript"></script>
       <script src="<?= URL ?>../assets/js/bootstrap4.5.2min.js"></script>
		...
		<script src="<?= URL; ?>../assets/clockpicker/bootstrap-clockpicker.min.js"></script>
