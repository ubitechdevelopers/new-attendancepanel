...
;(function ($, window, document, undefined) {    
  ...
  var defaults = {    
    addAllText: "Available Geo-fence",
    //removeAllText: "Remove All",
    selectedLabel: "Selected Geo-fence",
  ...
  Plugin.prototype = {
    init: function () {
      ...
      if (this.options.maxSelect != 0) {
        ...
        tmphtml = '<div class="lwms-filterhead"><a href="#" class="lwms-addall">' + this.options.addAllText + '</a>&nbsp; | &nbsp;<a href="#" class="lwms-removeall"></a></div>';
      }
